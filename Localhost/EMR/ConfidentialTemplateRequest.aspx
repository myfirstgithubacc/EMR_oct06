<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Include/Master/EMRMaster.master" CodeFile="ConfidentialTemplateRequest.aspx.cs" Inherits="EMR_ConfidentialTemplateRequest" %>
...
<script type="text/javascript">
    ...
    <%--    <asp:ScriptManager ID="Scrptmanger1" runat="server"></asp:ScriptManager>--%>
        ...
        <div class="container-fluid header_main">
            <div class="col-md-2">
                <h2>Confidential Template Request</h2>
            </div>
            ...
            <div class="row" id="Table2" runat="server">
                <div class="col-md-offset-4 col-md-4">
                    <div class="row form-groupTop01">
                        <asp:Label ID="lblConfidentialTemplate" runat="server" Text="Confidential Template Request"></asp:Label>
                          <telerik:RadComboBox ID="ddlConfidentialTemplate" runat="server" EmptyMessage="[ Select ]"
                    ...
                    <div class="row margin_Top">
                        ...
                        <div class="col-md-7">
                            ...
                            <asp:Button ID="btnclose" runat="server" Text="Close (Ctrl+F8)" CssClass="btn btn-primary" Visible="false" CausesValidation="false" OnClientClick="window.close();" />
                        </div>
                    </div>
