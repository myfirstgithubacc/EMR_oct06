...
public partial class EMR_Medication_PrescribeMedicationLightWeight : System.Web.UI.Page
{
    ...
    private enum enumColumns : byte
    {
        ...
        IndentType = 12,
        TotalQty = 13,
        PrescriptionDetail = 14,
        BrandDetailsCIMS = 15,
        MonographCIMS = 16,
        InteractionCIMS = 17,
        DHInteractionCIMS = 18,
        DAInteractionCIMS = 19,
        BrandDetailsVIDAL = 20,
        MonographVIDAL = 21,
        InteractionVIDAL = 22,
        DHInteractionVIDAL = 23,
        DAInteractionVIDAL = 24,
        Edit = 25,
        Delete = 26
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        #region Visibilty False



        //// Label5.Visible=false;
        ////ddlReferanceItem.Visible=false;
        ////Label29.Visible=false;
        ////txtVolume.Visible=false;
        ////Label34.Visible=false;
        ////ddlVolumeUnit.Visible=false;
        ////Label35.Visible=false;
        ////txtFlowRateUnit.Visible=false;
        ////Label36.Visible=false;
        ////ddlFlowRateUnit.Visible=false;
        ////Label20.Visible=false;
        ////Label32.Visible=false;
        ////Label33.Visible=false;
        ////txtTotalVolumn.Visible=false;
        ////txtTimeInfusion.Visible=false;
        ////ddlTimeUnit.Visible = false;
        #endregion Visibility False end
        ...
        //maindivofControl.Visible = false;
        //btnVariableDose.Visible = false;
        btnCopyLastPrescription.Visible = true;
        if (!IsPostBack)
        {
            try
            {
                ...
                string strEMRPrescriptionDoseShowInFractionalValue = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]),
                                                        common.myInt(Session["FacilityId"]), "EMRPrescriptionDoseShowInFractionalValue", sConString);

                chkFractionalDose.Checked = strEMRPrescriptionDoseShowInFractionalValue.Equals("Y");

                Session["EMRPrescriptionDoseCalculateBasedOnWeight"] = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]),
                                                        common.myInt(Session["FacilityId"]), "EMRPrescriptionDoseCalculateBasedOnWeight", sConString);
                ...
                Session["IncludeToContinueDurationInPrescription"] = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationID"]), common.myInt(Session["FacilityID"]), "IncludeToContinueDurationInPrescription", sConString);

                if (!common.myStr(Session["IncludeToContinueDurationInPrescription"]).Equals("Y"))
                {
                ...
                ViewState["IsRemovePrescriptionPopUpMsgForItemsNotInStock"] = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]),
                                        common.myInt(Session["FacilityId"]), "IsRemovePrescriptionPopUpMsgForItemsNotInStock", sConString);
                ...
                ViewState["ShowStockQtyInPrescription"] = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]),
                                                  common.myInt(Session["FacilityId"]), "ShowStockQtyInPrescription", sConString);
                //ddlBrand.Focus();
                if (common.myStr(Request.QueryString["IsEMRPopUp"]).Equals("1"))
                {
    ...
    private void bindOnLoadData()
    {
        ...
        try
        {
            ...
            {
                int wardid = common.myInt(dsPatientDetailPrescription.Tables[0].Rows[0]["WardId"]);
              ...
              common.myInt(Session["LoginDepartmentId"]), common.myInt(Session["EmployeeId"]), common.myInt(dsPatientDetailPrescription.Tables[0].Rows[0]["WardId"]));
            }
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                ddlStore.DataBind();
                ddlStore.Items.Insert(0, new RadComboBoxItem(string.Empty, "0"));
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            if (ds.Tables.Count > 5)
            {
                ...
                //txtICDCode.Text = string.Empty;//Omprakash Sharma
            ...
            if (ds.Tables.Count > 7)
            {
                ...
                //ddlFlowRateUnit.DataSource = DV.ToTable();//Omprakash Sharma
            ...
            if (ds.Tables.Count > 9)
            {
                ...
                {
                    ViewState["ddlRoute"] = ds.Tables[9];
            ...
            // RadComboBox ddlFrequencyId = (RadComboBox)gvItem.FindControl("ddlFrequencyId");

            if (ds.Tables.Count > 10)
            {
                ViewState["ddlFrequencyId"] = ds.Tables[10];//Omprakash Sharma
            ...
            {
                ViewState["ddlFoodRelation"] = ds.Tables[11];
                //ddlFoodRelation.DataSource = ds.Tables[11];//Omprakash Sharma
            ...
            {
                ViewState["ddlDoseType"] = ds.Tables[12];
                //ddlDoseType.DataSource = ds.Tables[12];//Omprakash Sharma
            ...
            if (ds.Tables.Count > 13)
            {
                ...
                if (ds.Tables[13].Rows.Count > 0)
                {
                    if (common.myBool(ds.Tables[13].Rows[0]["IsCIMSInterfaceActive"]))
                    {
                        ...
                        chkShowDetails.Text = "CIMS";
                        chkShowDetails.ToolTip = "Show CIMS Details";
                    }
                    else if (common.myBool(ds.Tables[13].Rows[0]["IsVIDALInterfaceActive"]))
                    {
                        ...
                        chkShowDetails.Visible = true;
                        chkShowDetails.Text = "VIDAL";
                        chkShowDetails.ToolTip = "Show VIDAL Details";
                    }
                }
    ...
    protected void saveData()
    {
        ...
        try
        {
            ...
            {
                #region OP Drug
                for (int k = 0; k < gvItem.Rows.Count; k++)
                {
                    coll1 = new ArrayList();
                    coll1 = new ArrayList();
                    HiddenField hdnGDGenericId = (HiddenField)gvItem.Rows[k].FindControl("hdnGenericId");
                    HiddenField hdnGDItemId = (HiddenField)gvItem.Rows[k].FindControl("hdnItemId");
                    TextBox txtTotalQty = (TextBox)gvItem.Rows[k].FindControl("txtTotalQty");
                    HiddenField hdnIndentId = (HiddenField)gvItem.Rows[k].FindControl("hdnIndentId");
                    Label lblItemName = (Label)gvItem.Rows[k].FindControl("lblItemName");
                    HiddenField hdnNotToPharmcy = (HiddenField)gvItem.Rows[k].FindControl("hdnNotToPharmcy");
                    HiddenField hdnStartDate = (HiddenField)gvItem.Rows[k].FindControl("hdnStartDate");
                    HiddenField hdnUnAppPrescriptionId = (HiddenField)gvItem.Rows[k].FindControl("hdnUnAppPrescriptionId");
                    HiddenField hdnFormulationId = (HiddenField)gvItem.Rows[k].FindControl("hdnFormulationId");
                    HiddenField hdnRouteId = (HiddenField)gvItem.Rows[k].FindControl("hdnRouteId");
                    HiddenField hdnStrengthId = (HiddenField)gvItem.Rows[k].FindControl("hdnStrengthId");
                    HiddenField hdnStrengthValue = (HiddenField)gvItem.Rows[k].FindControl("hdnStrengthValue");
                    HiddenField hdnXMLData = (HiddenField)gvItem.Rows[k].FindControl("hdnXMLData");
                    Label lblPrescriptionDetail = (Label)gvItem.Rows[k].FindControl("lblPrescriptionDetail");
                    HiddenField hdnCustomMedication = (HiddenField)gvItem.Rows[k].FindControl("hdnCustomMedication");
                    RadComboBox ddlFoodRelation = (RadComboBox)gvItem.Rows[k].FindControl("ddlFoodRelation");
                    //RadComboBox ddlRoute = (RadComboBox)gvItem.Rows[k].FindControl("ddlRoute");
                    RadComboBox ddlUnit = (RadComboBox)gvItem.Rows[k].FindControl("ddlUnit");
                    RadComboBox ddlFrequencyId = (RadComboBox)gvItem.Rows[k].FindControl("ddlFrequencyId");
                    RadComboBox ddlPeriodType = (RadComboBox)gvItem.Rows[k].FindControl("ddlPeriodType");
                    RadComboBox ddlDoseType = (RadComboBox)gvItem.Rows[k].FindControl("ddlDoseType");
                    TextBox txtDose = (TextBox)gvItem.Rows[k].FindControl("txtDose");
                    HiddenField hdnItemId = (HiddenField)gvItem.Rows[k].FindControl("hdnItemId");
                    TextBox txtDuration = (TextBox)gvItem.Rows[k].FindControl("txtDuration");
                    Label lblItemNameID = (Label)gvItem.Rows[k].FindControl("lblItemNameID");
                    Label lblIndentId = (Label)gvItem.Rows[k].FindControl("lblIndentId");
                    HiddenField hdnXmlVariableDose = (HiddenField)gvItem.Rows[k].FindControl("hdnXmlVariableDose");
                    ...
                    hdnGDItemId.Value = lblItemNameID.Text;
                    hdnIndentId.Value = lblIndentId.Text;
                    ...
                    if (common.myInt(hdnIndentId.Value).Equals(0))
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            HiddenField hdnCommentsDrugAllergy = (HiddenField)gvItem.Rows[k].FindControl("hdnCommentsDrugAllergy");
                            HiddenField hdnCommentsDrugToDrug = (HiddenField)gvItem.Rows[k].FindControl("hdnCommentsDrugToDrug");
                            HiddenField hdnCommentsDrugHealth = (HiddenField)gvItem.Rows[k].FindControl("hdnCommentsDrugHealth");
            ...
            if (common.myStr(Session["OPIP"]).Equals("I"))
            {
                hshOutput = objWM.SaveEMRMedicine(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]),
                    ...
                    isConsumable, sXMLFre, strXMLUnAppPrescIds.ToString(), 0, common.myStr(Request.QueryString["LOCATION"]).Equals("WARD"), ApprovalRequired);
            }
            else
            {
    ...
    //protected void ddlFormulation_OnSelectedIndexChanged(object sender, EventArgs e)//Omprakash Sharma
    //{
    //    try
    //    {
        ...
        try
        {
            ...
            if (common.myStr(Session["OPIP"]).Equals("I"))
            {
                dsSearch = objPhr.getItemsWithStock(common.myInt(Session["HospitalLocationID"]), StoreId, ItemId, itemBrandId, GenericId,
                                                                   ...
                                                                   text.Replace("'", "''"), WithStockOnly, string.Empty, iOT, "IP",
            ...
            else
            {
                dsSearch = objPhr.getItemsWithStock(common.myInt(Session["HospitalLocationID"]), StoreId, ItemId, itemBrandId, GenericId,
                                                                                  common.myInt(Session["UserId"]), common.myInt(Session["FacilityId"]), 0,
                                                                                  text.Replace("'", "''"), WithStockOnly, string.Empty, iOT, string.Empty,
                                                                                  common.myBool(IsPackagePatient), common.myBool(IsPanelPatient)
                                                                                  , common.myBool(Session["AllowPanelExcludedItems"]), common.myInt(Session["GroupID"]), common.myInt(Session["EmployeeId"]), "I", CompanyId,0);
            }
    ...
    //protected void ddlFrequency_OnSelectedIndexChanged(object sender, EventArgs e)//Omprakash Sharma
    //{
    //    try
    //    {
    ...
    //private void calcTotalQty()//Omprakash Sharma
    //{
    //    try
    //    {
    ...
    protected void gvItem_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            try
            {
                ...
                HiddenField lblUnitId = (HiddenField)e.Row.FindControl("lblUnitId");
                ...
                //RadComboBox ddlRoute = (RadComboBox)e.Row.FindControl("ddlRoute");
                ...
                HiddenField lblUnitId1 = (HiddenField)e.Row.FindControl("lblUnitId");
                HiddenField lblFrequencyId = (HiddenField)e.Row.FindControl("lblFrequencyId");
                HiddenField lblFoodRelation = (HiddenField)e.Row.FindControl("lblFoodRelation");
                HiddenField lblRoute = (HiddenField)e.Row.FindControl("lblRoute");
                HiddenField hdnddlDoseTypeid = (HiddenField)e.Row.FindControl("hdnddlDoseTypeid");
                HiddenField lblPeriodType = (HiddenField)e.Row.FindControl("lblPeriodType");
                ...
                if (lblPeriodType.Value != " " && lblPeriodType.Value != "")
                {
                    ddlPeriodType.SelectedValue = lblPeriodType.Value;
                }


                DataTable dt1 = (DataTable)ViewState["UnitMaster"];
                if (dt1.Rows.Count > 0)
                {
                    ...
                    {
                        Telerik.Web.UI.RadComboBoxItem item = new Telerik.Web.UI.RadComboBoxItem();
                        item.Text = (string)dt1.Rows[i]["UnitName"];
                        item.Value = common.myStr(dt1.Rows[i]["Id"]);
                        ddlUnit.Items.Add(item);
                        item.DataBind();
                    }
                    ddlUnit.Items.Insert(0, new RadComboBoxItem("Select", string.Empty));
                    ddlUnit.SelectedValue = lblUnitId1.Value;
                }

                dt1 = (DataTable)ViewState["ddlFrequencyId"];
                if (dt1.Rows.Count > 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        Telerik.Web.UI.RadComboBoxItem item = new Telerik.Web.UI.RadComboBoxItem();
                        item.Text = (string)dt1.Rows[i]["Description"];
                        item.Value = common.myStr(dt1.Rows[i]["Id"]);
                        ddlFrequencyId.Items.Add(item);
                        item.DataBind();
                    }
                    ddlFrequencyId.Items.Insert(0, new RadComboBoxItem("Select", string.Empty));
                    ddlFrequencyId.SelectedValue = lblFrequencyId.Value;
                }

                dt1 = (DataTable)ViewState["ddlFoodRelation"];
                if (dt1.Rows.Count > 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        Telerik.Web.UI.RadComboBoxItem item = new Telerik.Web.UI.RadComboBoxItem();
                        item.Text = (string)dt1.Rows[i]["FoodName"];
                        item.Value = common.myStr(dt1.Rows[i]["Id"]);
                        ddlFoodRelation.Items.Add(item);
                        item.DataBind();
                    }
                    ddlFoodRelation.Items.Insert(0, new RadComboBoxItem("Select", string.Empty));
                    ddlFoodRelation.SelectedValue = lblFoodRelation.Value;
                }

                dt1 = (DataTable)ViewState["ddlRoute"];
                if (dt1.Rows.Count > 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        Telerik.Web.UI.RadComboBoxItem item = new Telerik.Web.UI.RadComboBoxItem();
                        item.Text = (string)dt1.Rows[i]["RouteName"];
                        item.Value = common.myStr(dt1.Rows[i]["Id"]);
                        ddlRoute.Items.Add(item);
                        item.DataBind();
                    }
                    ddlRoute.Items.Insert(0, new RadComboBoxItem("Select", string.Empty));
                    ddlRoute.SelectedValue = lblRoute.Value;
                }
                dt1 = (DataTable)ViewState["ddlDoseType"];
                if (dt1.Rows.Count > 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        Telerik.Web.UI.RadComboBoxItem item = new Telerik.Web.UI.RadComboBoxItem();
                        item.Text = (string)dt1.Rows[i]["Status"];
                        item.Value = common.myStr(dt1.Rows[i]["StatusId"]);
                        ddlDoseType.Items.Add(item);
                        item.DataBind();
                    }
                    ddlDoseType.Items.Insert(0, new RadComboBoxItem("Select", string.Empty));
                    ddlDoseType.SelectedValue = hdnddlDoseTypeid.Value;
                }
    ...
    protected void gvItem_OnRowCommand(object Sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            if (e.CommandName.ToUpper().Equals("ITEMDELETE"))
            {
                ...
                int ItemId = common.myInt(((Label)row.FindControl("lblItemNameID")).Text);
                ...
                if (ViewState["ItemDetail"] != null && lblItemName.Text != null)// && (ItemId > 0 || GenericId > 0 || common.myBool(hdnCustomMedication.Value)))
                {
                    ...
                    //if (common.myBool(hdnCustomMedication.Value))
                    //{
                    //    DV.RowFilter = "ISNULL(ItemName,0) <> '" + common.myStr(lblItemName.Text) + "'";
                    //    DV1.RowFilter = "ISNULL(ItemName,0) <> '" + common.myStr(lblItemName.Text) + "'";
                    ...
                    lblMessage.ForeColor = System.Drawing.Color.FromName(commonLabelSetting.cSucceedColor);
                    lblMessage.Text = lblItemName.Text + "............. Deleted !";
            ...
            else if (e.CommandName.ToUpper().Equals("SELECT"))
            {
                ...
                // txtStrengthValue.Text = common.myStr(hdnStrengthValue.Value);Omprakash Sharma
                if (ViewState["ItemDetail"] != null)
                {
                    dt = (DataTable)ViewState["ItemDetail"];
                }
                ...
                if (DV.ToTable().Rows.Count > 0)
                {
                    ...
                    if (xmlSchema != "")
                    {
                        ...
                        if (dtDetail.Rows.Count > 0)
                        {
                            ...
                            // txtICDCode.Text = common.myStr(dtDetail.Rows[0]["ICDCode"]); Omprakash Sharma
    ...
    protected void gvPrevious_OnRowCommand(object Sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            if (e.CommandName.ToUpper().Equals("SELECTITEM"))
            {
                ...
                //ddlFormulation.SelectedIndex = ddlFormulation.Items.IndexOf(ddlFormulation.Items.FindItemByValue(common.myInt(hdnFormulationId.Value).ToString())); Omprakash sharma
                //ddlFormulation.SelectedIndex = ddlFormulation.Items.IndexOf(ddlFormulation.Items.FindByValue(common.myInt(hdnFormulationId.Value).ToString())); Omprakash sharma
                //ddlRoute.SelectedIndex = ddlRoute.Items.IndexOf(ddlRoute.Items.FindItemByValue(common.myInt(hdnRouteId.Value).ToString())); Omprakash sharma
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (!IdentId.Equals(string.Empty) && !ItemId.Equals(string.Empty))
                {
                    if (common.myLen(hdnReturnIndentDetailsIds.Value) > 0)
                    {
                        ...
                        dv1.RowFilter = "ISNULL(DetailsId,0) IN (" + common.myStr(hdnReturnIndentDetailsIds.Value) + ")"; // AND ISNULL(ItemId,0) IN (" + ItemId + ") AND ISNULL(IndentId,0) IN (" + IdentId + ") AND Source IN(" + common.myStr(hdnReturnIndentOPIPSource.Value) + ")";
                    }
                    else
                    {
                    ...
                    if (!IdentId.Equals(string.Empty) && !ItemId.Equals(string.Empty))
                    {
                        try
                        {
                            ...
                            for (int idx = 0; idx < dt.Rows.Count; idx++)
                            {
                                ...
                                dt.Rows[idx]["StartDate"] = common.myDate(txtStartDate.SelectedDate).ToString("dd/MM/yyyy");// DateTime.Now.ToString("dd/MM/yyyy");
            ...
            if (DVItem.ToTable().Rows.Count.Equals(0))
            {
                ...
                if (dv.Count > 0)
                {
                    ...
                    foreach (DataRow drM in dt.Rows)
                    {
                        ...
                        DR["ICDCode"] = string.Empty;// common.myStr(txtICDCode.Text);
                        DR["StrengthValue"] = string.Empty;
                        DR["ReferanceItemId"] = 0;
                ...
                if (dv.Count > 0)
                {
                    ...
                    foreach (DataRow drM in dt.Rows)
                    {
                        ...
                        if (!IsExists)
                        {
                            ...
                            DR1["OverrideCommentsDrugHealth"] = string.Empty;
                            DR1["IsSubstituteNotAllowed"] = 0;
                            DR1["ICDCode"] = string.Empty;// common.myStr(txtICDCode.Text);
                            DR1["StrengthValue"] = string.Empty;
                            DR1["ReferanceItemId"] = 0;
                            DR1["UnitId"] = common.myInt(drM["DoseUnitId"]);
                            DR1["NotToPharmacy"] = false;
    ...
    protected void btnAddItem_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (!common.myStr(ViewState["ProceedValue"]).Equals("F"))
                {
                    string IsAutoAddFavirateInPrescription = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]),
                                            common.myInt(Session["FacilityId"]), "IsAutoAddFavirateInPrescription", sConString);
                    if (IsAutoAddFavirateInPrescription.Equals("Y"))
                    {
    ...
    private void addItem(string sICDCode)
    {
        ...
        try
        {
            DataRow DR1;
            {
                ...
                DR1["RouteName"] = common.myStr(ddlRoute.Text);
                DR1["Qty"] = common.myDbl(0).ToString("F2"); //dQty.ToString("F2");
                ...
                DR1["ItemId"] = common.myInt(ViewState["chkRow_lstallbrandsID"]);
                ...
                DR1["ItemName"] = chkCustomMedication.Checked ? common.myStr(txtCustomMedication.Text).Trim() : common.myStr(ViewState["chkRow_lstallbrands"]);
                DR1["StrengthValue"] = "";// common.myStr(txtStrengthValue.Text);
                //  DR1["Dose"] = common.myStr(common.myInt(txtDose.Text));
                DR1["Dose"] = common.myStr(common.myDbl(0));
                DR1["Frequency"] = 0;// common.myInt(ddlFrequencyId.SelectedValue).Equals(0) ? 0 : common.myDbl(ddlFrequencyId.SelectedItem.Attributes["Frequency"]);
                ...
                DR1["FoodRelationshipId"] = 0;// common.myInt(ddlFoodRelation.SelectedValue);
                DR1["FoodRelationship"] = 0;// common.myInt(ddlFoodRelation.SelectedValue).Equals(0) ? string.Empty : common.myStr(ddlFoodRelation.Text);
                DR1["UnitId"] = 0;// common.myInt(ddlUnit.SelectedValue);
                DR1["UnitName"] = 0;// common.myInt(ddlUnit.SelectedValue).Equals(0) ? string.Empty : common.myStr(ddlUnit.Text);
                DR1["CIMSItemId"] = common.myStr(hdnCIMSItemId.Value);
                DR1["CIMSType"] = common.myStr(hdnCIMSType.Value);
                DR1["VIDALItemId"] = common.myInt(hdnVIDALItemId.Value);
                DR1["PrescriptionDetail"] = string.Empty;
                DR1["CustomMedication"] = chkCustomMedication.Checked;
                DR1["Instructions"] = "";// common.clearHTMLTags(txtInstruction.Text);
                DR1["ReferanceItemId"] = 0;// common.myInt(ddlReferanceItem.SelectedValue);
                DR1["ReferanceItemName"] = 0;// common.myInt(ddlReferanceItem.SelectedValue).Equals(-1) ? string.Empty : common.myStr(ddlReferanceItem.Text);
                DR1["DoseTypeId"] = 0;// common.myInt(ddlDoseType.SelectedValue);
                DR1["DoseTypeName"] = 0;//common.myInt(ddlDoseType.SelectedValue).Equals(0) ? string.Empty : common.myStr(ddlDoseType.Text);
                DR1["FormulationId"] = common.myInt(ddlFormulation.SelectedValue);
                DR1["FormulationName"] = common.myStr(ddlFormulation.Text);
                ...
                DR1["FrequencyId"] = 0;// common.myInt(ddlFrequencyId.SelectedValue);
                DR1["FrequencyName"] = "";// common.myStr(ddlFrequencyId.Text); //common.myStr(ddlFrequencyId.SelectedItem.Text);
                DR1["Volume"] = "";// common.myStr(txtVolume.Text);
                DR1["VolumeUnitId"] = 0;// common.myInt(ddlVolumeUnit.SelectedValue);
                ...
                DR1["FlowRate"] = "0";
                DR1["FlowRateUnit"] = 0;// common.myInt(ddlFlowRateUnit.SelectedValue);
                ...
                dvRemoveBlank = dt1.Copy().DefaultView;
                dvRemoveBlank.RowFilter = "ItemName <> '" + common.myStr(lblItemName.Text, true) + "'";
                dt1 = dvRemoveBlank.ToTable();
                dt1 = addColumnInItemGrid(dt1);
                ViewState["ItemDetail"] = dt1;
                ViewState["Item"] = dt1;
                dt1 = RemoveDuplicateRows(dt1, dt1.Columns["ItemName"].ToString());
    ...
    private void addGVItem()
    {
        ...
        DataView dv = new DataView();
        DataView dv1 = new DataView();
        DataTable dtData = new DataTable(); DataTable dtData1 = new DataTable();
        DataTable dtPD = new DataTable();
        try
        {
            DataRow DR1;
            decimal dQty = 0;
            {
                ...
                dt = CreateItemTable();
                DR1 = dt1.NewRow();
                //int j = common.myInt(rowid);
                for (int j = 0; j < gvItem.Rows.Count; j++)
                {
                    TextBox txtDose = (TextBox)gvItem.Rows[j].FindControl("txtDose");
                    RadComboBox ddlUnit = (RadComboBox)gvItem.Rows[j].FindControl("ddlUnit");
                    RadComboBox ddlFrequencyId = (RadComboBox)gvItem.Rows[j].FindControl("ddlFrequencyId");
                    TextBox txtDuration = (TextBox)gvItem.Rows[j].FindControl("txtDuration");
                    RadComboBox ddlPeriodType = (RadComboBox)gvItem.Rows[j].FindControl("ddlPeriodType");
                    RadComboBox ddlStatPRN = (RadComboBox)gvItem.Rows[j].FindControl("ddlStatPRN");
                    RadComboBox ddlDoseType = (RadComboBox)gvItem.Rows[j].FindControl("ddlDoseType");
                    RadTextBox txtInstruction = (RadTextBox)gvItem.Rows[j].FindControl("txtInstruction");
                    RadComboBox ddlFoodRelation = (RadComboBox)gvItem.Rows[j].FindControl("ddlFoodRelation");
                    //RadComboBox ddlRoute = (RadComboBox)gvItem.Rows[j].FindControl("ddlRoute");
                    //RadDatePicker txtStartDate = (RadDatePicker)gvItem.Rows[j].FindControl("txtStartDate");
                    //txtStartDate.SelectedDate = common.myDate(DateTime.Now.ToShortDateString());
                    //RadDatePicker txtEndDate = (RadDatePicker)gvItem.Rows[j].FindControl("txtStartDate");
                    //txtEndDate.SelectedDate = common.myDate(DateTime.Now.ToShortDateString());
                    TextBox txtStrengthValue = (TextBox)gvItem.Rows[j].FindControl("txtStrengthValue");
                    //CheckBox chkNotToPharmacy = (CheckBox)gvItem.Rows[j].FindControl("chkNotToPharmacy");
                    //RadComboBox ddlFormulation = (RadComboBox)gvItem.Rows[j].FindControl("ddlFormulation");
                    RadComboBox ddlReferanceItem = (RadComboBox)gvItem.Rows[j].FindControl("ddlReferanceItem");
                    TextBox txtTotQty = (TextBox)gvItem.Rows[j].FindControl("txtTotQty");
                    TextBox txtVolume = (TextBox)gvItem.Rows[j].FindControl("txtVolume");
                    RadComboBox ddlVolumeUnit = (RadComboBox)gvItem.Rows[j].FindControl("ddlVolumeUnit");
                    TextBox txtTimeInfusion = (TextBox)gvItem.Rows[j].FindControl("txtTimeInfusion");
                    RadComboBox ddlTimeUnit = (RadComboBox)gvItem.Rows[j].FindControl("ddlTimeUnit");
                    TextBox txtTotalVolumn = (TextBox)gvItem.Rows[j].FindControl("txtTotalVolumn");
                    TextBox txtFlowRateUnit = (TextBox)gvItem.Rows[j].FindControl("txtFlowRateUnit");
                    RadComboBox ddlFlowRateUnit = (RadComboBox)gvItem.Rows[j].FindControl("ddlFlowRateUnit");
                    //CheckBox chkSubstituteNotAllow = (CheckBox)gvItem.Rows[j].FindControl("chkSubstituteNotAllow");
                    TextBox txtICDCode = (TextBox)gvItem.Rows[j].FindControl("txtICDCode");
                    HiddenField hdnGDItemId = (HiddenField)gvItem.Rows[j].FindControl("hdnItemId");
                    Label lblItemName = (Label)gvItem.Rows[j].FindControl("lblItemName");
                    Label lblItemNameID = (Label)gvItem.Rows[j].FindControl("lblItemNameID");
                    Label lblPrescriptionDetail = (Label)gvItem.Rows[j].FindControl("lblPrescriptionDetail");
                    HiddenField hdnIndentId = (HiddenField)gvItem.Rows[j].FindControl("hdnIndentId");
                    HiddenField hdnXMLData = (HiddenField)gvItem.Rows[j].FindControl("hdnXMLData");
                    HiddenField hdnGenericName = (HiddenField)gvItem.Rows[j].FindControl("hdnGenericName");
                    HiddenField hdnItemId = (HiddenField)gvItem.Rows[j].FindControl("hdnItemId");
                    HiddenField lblUnitId = (HiddenField)gvItem.Rows[j].FindControl("lblUnitId");
                    HiddenField hdnIsSubstituteNotAllowed = (HiddenField)gvItem.Rows[j].FindControl("hdnIsSubstituteNotAllowed");
                    HiddenField hdnFormulationId = (HiddenField)gvItem.Rows[j].FindControl("hdnFormulationId");
                    HiddenField hdnRouteId = (HiddenField)gvItem.Rows[j].FindControl("hdnRouteId");
                    HiddenField hdnStartDate = (HiddenField)gvItem.Rows[j].FindControl("hdnStartDate");
                    HiddenField hdnNotToPharmcy = (HiddenField)gvItem.Rows[j].FindControl("hdnNotToPharmcy");
                    HiddenField hdnRouteName = (HiddenField)gvItem.Rows[j].FindControl("hdnRouteName");
                    HiddenField hdnFormulationName = (HiddenField)gvItem.Rows[j].FindControl("hdnFormulationName");
                    HiddenField hdnCustomMedication = (HiddenField)gvItem.Rows[j].FindControl("hdnCustomMedication");
                    HiddenField hdnUnAppPrescriptionId = (HiddenField)gvItem.Rows[j].FindControl("hdnUnAppPrescriptionId");
                    string sFrequency = "0";
                    ...
                    {
                        sFrequency = common.myStr(ddlFrequencyId.SelectedValue);
                    }
                    string sLocation = common.myStr(Request.QueryString["LOCATION"]);
                    string Type = string.Empty;
                    decimal dDuration = 0;
                    ...
                    DR1["RouteId"] = common.myInt(hdnRouteId.Value);
                    DR1["RouteName"] = common.myStr(hdnRouteName.Value);
                    DR1["Qty"] = common.myDbl(txtTotQty.Text).ToString("F2");
                    DR1["GenericId"] = common.myInt(hdnGenericId.Value);
                    DR1["ItemId"] = common.myInt(lblItemNameID.Text);
                    DR1["GenericName"] = common.myStr(hdnGenericName.Value);
                    DR1["ItemName"] = common.myStr(lblItemName.Text);
                    DR1["StrengthValue"] = common.myStr(txtStrengthValue.Text);
                    ...
                    DR1["DurationText"] = common.myStr(Type);
                    DR1["Type"] = common.myStr(ddlPeriodType.SelectedValue);
                    //if (common.myStr(hdnStartDate) != "")
                    //DR1["StartDate"] = hdnStartDate.Value;// common.myDate(hdnStartDate.Value).ToString("dd/MM/yyyy");
                    //else
                    //   DR1["StartDate"] = null;
                    if (common.myStr(hdnStartDate.Value) != "")
                        DR1["StartDate"] = common.myDate(hdnStartDate.Value).ToString("dd/MM/yyyy");
                    else
                        DR1["StartDate"] = null;
                    ...
                    DR1["VIDALItemId"] = common.myInt(hdnVIDALItemId.Value);
                    DR1["PrescriptionDetail"] = string.Empty;
                    DR1["CustomMedication"] = common.myBool(hdnCustomMedication.Value); //chkCustomMedication.Checked;
                    ...
                    DR1["FormulationId"] = common.myInt(hdnFormulationId.Value);// common.myInt(ddlFormulation.SelectedValue);                    
                    DR1["FormulationName"] = common.myStr(hdnFormulationName.Value);
                    DR1["IsInfusion"] = true;
                    ...
                    DR1["OverrideCommentsDrugToDrug"] = common.myStr(txtCommentsDrugToDrug.Text);
                    DR1["OverrideCommentsDrugHealth"] = common.myStr(txtCommentsDrugHealth.Text);
                    DR1["IsSubstituteNotAllowed"] = common.myBool(hdnIsSubstituteNotAllowed.Value);// chkSubstituteNotAllow.Checked;
                    DR1["ICDCode"] = common.myStr(txtICDCode.Text);
                    DR1["NotToPharmacy"] = common.myBool(hdnNotToPharmcy.Value);// chkNotToPharmacy.Checked;
                    DR1["IndentId"] = 0;
                    DR1["UnAppPrescriptionId"] = hdnUnAppPrescriptionId.Value;

                    #region WITHOUT PRESCRIPTION DETAIL
                    ...
                    //dt1.TableName = "ItemDetail";
                    //StringBuilder builder1 = new StringBuilder();// Create the StringWriter object with the StringBuilder object.
                    //System.IO.StringWriter writer1 = new System.IO.StringWriter(builder1);// Write the schema into the StringWriter.
                    //dt1.WriteXml(writer1);
                    //string xmlSchema1 = writer1.ToString();
                    //xmlSchema1 = xmlSchema1.Replace("&lt;", "<");
                    //xmlSchema1 = xmlSchema1.Replace("&gt;", ">");

                    //////working
                    //DR1["XMLData"] = xmlSchema1;
                    //dtPD = dt1.Copy().Clone();
                    //dtPD.Rows.Add(DR1.ItemArray);
                    //if (common.myStr(txtStartDate.SelectedDate) != "")
                    //    DR1["PrescriptionDetail"] = objEMR.GetPrescriptionDetailStringNew(dtPD) + " , Start Date : " + (common.myDate(txtStartDate.SelectedDate).ToString("dd/MM/yyyy"));
                    //else
                    //    DR1["PrescriptionDetail"] = objEMR.GetPrescriptionDetailStringNew(dtPD);
                    //DR1["PrescriptionDetail"] = common.myStr(DR1["PrescriptionDetail"]);                   
                    ...
                    dtPD.Rows.Add(DR1.ItemArray);
                    if (common.myStr(hdnStartDate.Value) != "")
                        DR1["PrescriptionDetail"] = objEMR.GetPrescriptionDetailStringNew(dtPD, common.myStr(Session["EMRPrescriptionDoseShowInFractionalValue"])) + " , Start Date : " + (common.myDate(hdnStartDate.Value).ToString("dd/MM/yyyy"));
                    else
                        DR1["PrescriptionDetail"] = objEMR.GetPrescriptionDetailStringNew(dtPD, common.myStr(Session["EMRPrescriptionDoseShowInFractionalValue"]));
                    DR1["XMLData"] = common.myStr(DR1["XMLData"]);
    ...
    private void addFavItem(string sICDCode)
    {
        ...
        try
        {
            ...
            if (ItemId > 0)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (common.myStr(Session["EMRPrescriptionDoseCalculateBasedOnWeight"]).Equals("Y")
                    ...
                    if (common.myInt(DR["ClosingBalance"]).Equals(0) && common.myStr(Session["OPIP"]).Equals("I"))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                string strr = ViewState["PrescriptionAllowForItemsNotInStockShowAlert"].ToString();
    ...
    protected void btnAddtoFav_Click(object sender, EventArgs e)
    {
        lblMessage.ForeColor = System.Drawing.Color.FromName(commonLabelSetting.cSucceedColor);
        BaseC.clsEMR objEMR = new BaseC.clsEMR(sConString);
        LinkButton btnAddtoFav = sender as LinkButton;
        hdnItemId.Value = common.myStr(btnAddtoFav.CommandArgument);
        try
        {
            if (!common.myStr(hdnItemId.Value).Equals(string.Empty) && ddlBrand.SelectedValue != null && !chkCustomMedication.Checked)
            {
                ...
                string strMsg = objEMR.SaveFavouriteDrugs(DoctorId, common.myInt(hdnItemId.Value), string.Empty, common.myInt(Session["UserID"]),
                                        common.myDbl(0), common.myInt(0), 0,
                                        common.myInt(0), common.myInt(0),
                                        common.myInt(0), common.myInt(0),
                                        common.myStr(0), common.myInt(0),
                                        common.myStr(0), common.myStr(string.Empty), 0);
                lblMessage.Text = strMsg;
                GetBrandFavouriteData(string.Empty);
            }
            else
        ...
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("SELECTITEM"))
            {
                if (ItemId > 0)
                {
                    ...
                    //txtInstructions.Text = common.myStr(hndInstructions.Value);
                    ...
                    //if (common.myDbl(txtDose.Text).Equals(0.0))//Omprakash Sharma
                    //{
                    //    txtDose.Text = string.Empty;//"1"
                    //}
                    //if (common.myStr(Session["OPIP"]).Equals("I"))
            ...
            else if (e.CommandName.ToUpper().Equals("ITEMDELETE"))
            {
                ...
                string sResult = objEMR.DeleteFavoriteDrugs(doctorid, ItemId, string.Empty, common.myInt(Session["UserId"]), 0);
    ...
    private void proceedFavourite(bool IsInContinue)
    {
        ...
        try
        {
            foreach (GridViewRow rows in lstFavourite.Rows)
            {
                CheckBox chkrow = (CheckBox)rows.FindControl("chkRow");
                LinkButton lnkselect = (LinkButton)rows.FindControl("lnkItemName");
                if (chkrow.Checked == true)
                {
                    foreach (GridViewRow gvmrows in gvItem.Rows)
                    {
                        HiddenField hdnItemId = (HiddenField)gvmrows.FindControl("hdnItemId");
                        if (lnkselect.CommandArgument == hdnItemId.Value)
                        {
                            Alert.ShowAjaxMsg(lnkselect.Text + "    Already Select!.....", this.Page);
                            return;
                        }
                    }

                    ViewState["chkRow_lstallbrandsID"] = lnkselect.CommandArgument;
                    ViewState["chkRow_lstallbrands"] = lnkselect.Text;
                    lblMessage.ForeColor = System.Drawing.Color.FromName(commonLabelSetting.cErrorColor);
                    if (common.myInt(ViewState["OrderSetId"]) > 0)
                    {
                        AddOrderSet(common.myStr(ViewState["ICDCodes"]));
    ...
    private void proceedCurrent(bool IsInContinue)
    {
        ...
        try
        {
            foreach (GridViewRow rows in gvPrevious.Rows)
            {
                CheckBox chkrow = (CheckBox)rows.FindControl("chkRow");
                LinkButton lnkselect = (LinkButton)rows.FindControl("lnkItemName");
                if (chkrow.Checked == true)
    ...
    protected void rdoSearchMedication_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            txtFavouriteItemName.Text = ""; txtCurrentItemName.Text = ""; txtOrderSetName.Text = "";
    ...
    public void gvmitemselectedtrueandbind()
    {
        foreach (GridViewRow row in gvItem.Rows)
        {
            RadComboBox ddlUnit = (RadComboBox)row.FindControl("ddlUnit");
            RadComboBox ddlFrequencyId = (RadComboBox)row.FindControl("ddlFrequencyId");
            RadComboBox ddlPeriodType = (RadComboBox)row.FindControl("ddlPeriodType");
            RadComboBox ddlFoodRelation = (RadComboBox)row.FindControl("ddlFoodRelation");
            //RadComboBox ddlRoute = (RadComboBox)row.FindControl("ddlRoute");
            RadComboBox ddlDoseType = (RadComboBox)row.FindControl("ddlDoseType");
            TextBox txtDose = (TextBox)row.FindControl("txtDose");
    ...
    protected void chkRow_CheckedChanged(object sender, EventArgs e)
    {
        if (chkCustomMedication.Checked)
        {
            Alert.ShowAjaxMsg("Please Uncheck Custom Medication CheckBox....!", this.Page);
            return;
        }

        LinkButton lnk = (sender as LinkButton);
        ViewState["chkRow_lstallbrandsID"] = lnk.CommandArgument;
        ViewState["chkRow_lstallbrands"] = lnk.Text;


        foreach (GridViewRow gvmrows in gvItem.Rows)
        {
            HiddenField hdnItemId = (HiddenField)gvmrows.FindControl("hdnItemId");
            if (lnk.CommandArgument == hdnItemId.Value)
            {
                Alert.ShowAjaxMsg(lnk.Text + "    Already Select!.....", this.Page);
                return;
            }
        }

        checkitemquintity(common.myInt(lnk.CommandArgument));
    ...
    protected void imgaddcustommedication_Click(object sender, ImageClickEventArgs e)
    {
        addgenericandcustomitem(common.myStr(txtCustomMedication.Text.Trim()));
    }
    protected void imgaddgeneric_Click(object sender, ImageClickEventArgs e)
    {
        if (ddlGeneric.Text != null)
        {
            addgenericandcustomitem(common.myStr(ddlGeneric.Text));
        }
        else
        {
            Alert.ShowAjaxMsg("please select generic name", this.Page);
            return;
        }
    }
    ...
    public void addgenericandcustomitem(string itemname)
    {
        if (itemname == "") { Alert.ShowAjaxMsg("Please enter medication name", this.Page); return; }

        foreach (GridViewRow gvmrows in gvItem.Rows)
        {
            Label lblItemName = (Label)gvmrows.FindControl("lblItemName");
            if (itemname == lblItemName.Text)
            {
                lblMessage.ForeColor = System.Drawing.Color.FromName(commonLabelSetting.cErrorColor);
                lblMessage.Text = itemname + " Already Exists!";
                Alert.ShowAjaxMsg(itemname + " Already Exists!", this.Page);
                return;
            }
        }
        try
        {
            ViewState["chkRow_lstallbrandsID"] = 0;
            ViewState["chkRow_lstallbrands"] = common.myStr(itemname);
            addItem(common.myStr(ViewState["ICDCodes"]));
        }
        catch (Exception Ex)
        {
    ...
    {
        LinkButton lnk = (sender as LinkButton);
        ViewState["otheritemid"] = lnk.CommandArgument;
        for (int j = 0; j < gvItem.Rows.Count; j++)
        {
            Label hdnItemId = (Label)gvItem.Rows[j].FindControl("lblItemNameID");
            if (lnk.CommandArgument == hdnItemId.Text)
            {
                HiddenField hdnIsSubstituteNotAllowed = (HiddenField)gvItem.Rows[j].FindControl("hdnIsSubstituteNotAllowed");
                HiddenField hdnFormulationId = (HiddenField)gvItem.Rows[j].FindControl("hdnFormulationId");
                HiddenField hdnRouteId = (HiddenField)gvItem.Rows[j].FindControl("hdnRouteId");
                ...
                chkSubstituteNotAllow.Checked = common.myBool(hdnIsSubstituteNotAllowed.Value);
                ddlFormulation.SelectedValue = common.myStr(hdnFormulationId.Value);
                ddlRoute.SelectedValue = common.myStr(hdnRouteId.Value);
                txtStartDate.SelectedDate = common.myDate(hdnStartDate.Value);
                chkNotToPharmacy.Checked = common.myBool(hdnNotToPharmcy.Value);
            }
        }
    ...
    protected void btnSaveOther_Click(object sender, EventArgs e)
    {
        ...
        {
            Label hdnItemId = (Label)gvItem.Rows[j].FindControl("lblItemNameID");
            if (common.myInt(ViewState["otheritemid"]) == common.myInt(hdnItemId.Text))
            {
                HiddenField hdnIsSubstituteNotAllowed = (HiddenField)gvItem.Rows[j].FindControl("hdnIsSubstituteNotAllowed");
                HiddenField hdnFormulationId = (HiddenField)gvItem.Rows[j].FindControl("hdnFormulationId");
                HiddenField hdnRouteId = (HiddenField)gvItem.Rows[j].FindControl("hdnRouteId");
                ...
                hdnIsSubstituteNotAllowed.Value = common.myStr(chkSubstituteNotAllow.Checked);
                hdnFormulationId.Value = ddlFormulation.SelectedValue;
                hdnFormulationName.Value = ddlFormulation.Text;
                hdnRouteId.Value = ddlRoute.SelectedValue;
                hdnRouteName.Value = ddlRoute.Text;
                hdnStartDate.Value = common.myStr(txtStartDate.SelectedDate);
                hdnNotToPharmcy.Value = common.myStr(chkNotToPharmacy.Checked);
            }
        }
        //copyGVItem();
        clearItemDetails();
