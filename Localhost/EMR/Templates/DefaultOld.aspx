<%@ Page Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master" AutoEventWireup="true"
    CodeFile="DefaultOld.aspx.cs" Inherits="EMR_Templates_Default" Title="" MaintainScrollPositionOnPostback="true" %>
    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            function ctrlOnSelectedIndexChanged(ctrl, FieldId, FieldType) {
                ...
                else if (FieldType == "B" || FieldType == "R") {
                ...
                if (grid.rows.length > 0) {
                    if (FieldType == "D" || FieldType == "B" || FieldType == "R") {
                        for (ridx = 0; ridx < grid.rows.length; ridx++) {

                            cellParentId = grid.rows[ridx].cells[IdxParentId].innerText;

                            if (parseInt(cellParentId) == parseInt(FieldId) && parseInt(cellParentId) > 0) {

                                cellParentValue = grid.rows[ridx].cells[IdxParentValue].innerText;

                                if (parseInt(cellParentValue) == parseInt(ctrlSelectedValue) && parseInt(cellParentValue) > 0) {
        ...
        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
            <ContentTemplate>
                <telerik:RadWindowManager ID="RadWindowManager4" EnableViewState="false" runat="server">
                    <Windows>
        ...
        <asp:UpdatePanel ID="valMain" runat="server">
            <ContentTemplate>
                <div class="container-fluid header_main" style="padding: 1px 0 !important;">
                    <div class="row">
                        <asp:UpdatePanel ID="upd1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <asp:Label ID="lblMessage" ForeColor="Green" Font-Bold="true" Width="100%" runat="server" />
                                </div>
                                <div class="col-md-9 col-sm-9 text-right">
                                    <asp:LinkButton ID="lnkConsolidateLabReport" runat="server" ForeColor="Navy" Text="Consolidate Lab Report" OnClick="lnkConsolidateLabReport_Click" />
                                    <asp:CheckBox ID="chkPrintHospitalHeader" CssClass="Margintop" runat="server" Text="Print Header" />
                                    ...
                                    <asp:Button ID="btnPrintSection" runat="server" Text="Print Section" ToolTip="Print Report"
                                        OnClick="btnPrintSection_Click" CssClass="PatientBtn01a" />
                                    <asp:CheckBox ID="chkIncludePastHistory" OnCheckedChanged="chkIncludePastHistory_OnCheckedChanged" AutoPostBack="true" runat="server" Text="Include Past History" CssClass="text-right right cs1 Margintop" />
                                    <div style="width: 250px; float: left;">
                                        <telerik:RadComboBox ID="ddlReport" Visible="false" runat="server" Width="150px" EmptyMessage="[ Select ]" CssClass="PatientBtn01a" />
                                        <asp:Button ID="btnPrintTemplate" Visible="false" CssClass="PatientBtn01a pull-left" runat="server" Text="Print" OnClick="btnPrintTemplate_Click" />
                                    </div>
                                    <asp:Button ID="btnTemplateHistory" runat="server" Text="Past Notes" ToolTip="Past Notes"
                                        OnClick="btnTemplateHistory_Click" CssClass="PatientBtn01a" />
                                    <asp:Button ID="btnLastVisitDetails" runat="server" Text="Last Visit Details" ToolTip="Last Visit Details"
                                        OnClick="btnLastVisitDetails_OnClick" CssClass="PatientBtn01a" />
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                                ...
                                <div class="VitalHistory-Div02">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="PatientHistoryText01">
                                                    <div class="PD-TabRadio margin_z">
                                                        <asp:CheckBox ID="chkApprovalRequired" AutoPostBack="true" OnCheckedChanged="chkApprovalRequired_CheckedChanged" runat="server" Visible="false" Text="&nbsp;Approval Required" />
                                    ...
                                    <asp:Label ID="lblAdvisingDoctor" runat="server" Text="Advising&nbsp;Doctor" />
                                            ...
                                            <div class="col-md-3 col-sm-3" style="float: right;">
                                                ...
                                                <div class="col-lg-8">
                                                    <telerik:RadComboBox ID="ddlAdvisingDoctor" runat="server" Filter="Contains" Visible="false" MarkFirstMatch="true" EmptyMessage="/Select" DropDownWidth="300px" Width="100%" Skin="Metro" />
                                                </div>
                                            </div>
                                            <div class="ROW">
                                                <div class="col-md-12">
                                                                                ...
                                                                                <asp:GridView ID="gvSelectedServices" SkinID="gridview" runat="server" HeaderStyle-Wrap="false"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Values" ItemStyle-Width="35%" HeaderStyle-Width="35%"
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table id="tbl1" cellpadding="0" cellspacing="1" border="0" runat="server" class="form-group">
                                                                                                    <tr valign="top">
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="txtT" Font-Size="10pt" SkinID="textbox" CssClass="TextboxTemplate" Columns='<%#common.myInt(Eval("MaxLength"))%>'
                                                                                                                ...
                                                                                                                Height="20px" oncopy="return nocopy()" />
                                                                                                        </td>
                                                                                                        <td></td>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="txtM" SkinID="textbox" CssClass="TextboxTemplate" runat="server"
                                                                                                                TextMode="MultiLine" Style="min-height: 50px; max-height: 40px; width: 390px; background-color: #fff !important;"
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <telerik:RadComboBox ID="ddlTemplateFieldFormats" runat="server" EmptyMessage="[ Select ]"
                                                                                                                Width="200px" Visible="false" OnClientSelectedIndexChanged="wordProcessorOnSelectedIndexChanged" />
                                                                                                        ...
                                                                                                        <td valign="top" style="margin: 0 0 0 5px !important; float: left !important;">
                                                                                                ...
                                                                                                <table id="Table1" cellpadding="0" cellspacing="1" border="0" runat="server">
                                                                                                    <tr valign="top">
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <asp:DropDownList ID="D" SkinID="DropDown" Visible="false" runat="server" Width="227px" Font-Size="10pt" AppendDataBoundItems="true">
                                                                                                ...
                                                                                                <asp:RadioButtonList ID="B" Width="100px" runat="server" Visible="false" RepeatDirection="Horizontal">
