<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SentanceGallery.aspx.cs"
    Theme="DefaultControls" Inherits="EMR_Templates_SentanceGallery" Title="" %>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-9">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <asp:DropDownList ID="ddlOptions" Width="100%" runat="server">
                        ...
                        <div class="row m-t">
                            <div class="col-md-12 col-sm-12 col-xs-12 gridview">
                                <asp:GridView ID="gvSentenceGallery" CssClass="table table-condensed" HeaderStyle-CssClass="bg-primary" AllowPaging="true" PageSize="14"
