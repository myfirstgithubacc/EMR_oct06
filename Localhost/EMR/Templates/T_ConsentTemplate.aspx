<%@ Page Language="C#" AutoEventWireup="true" CodeFile="T_ConsentTemplate.aspx.cs" Inherits="EMR_Templates_T_ConsentTemplate" %>
...
<head runat="server"> 
    ...
    <title></title>
      ...
      <%--Sign JS--%>
    <script src="../../Include/JS/jquery-1.4.1.min.js"></script>
    <script src="../../Include/JS/jquery-1.8.2.js"></script>
   
     <script src="../../Include/Signature/jquery.min.js"></script>
        <script src="../../Include/Signature/JavaScript.js"></script>
    ...
    <script type="text/javascript">
        ...
        function DateFill() {
            ...
            if (document.getElementById("hdnFormName").value == "GENERAL CONSENT FORM NEW1") {
                debugger

                document.getElementById("txtdate1").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate2").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate3").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');

                //var date = new Date();
                //var currentTime = date.getHours() + ':' + date.getMinutes();
                //document.getElementById("txtTime1").value = currentTime;

                //document.getElementById("txt_PatientName").value = document.getElementById("hdnPatientName").value;
                //document.getElementById("txt_MRN").value = document.getElementById("hdnMRN").value;
                document.getElementById("txt_FullPatName").value = document.getElementById("hdnFullPatName").value;
                document.getElementById("txt_FullPatName1").value = document.getElementById("hdnFullPatName").value;

                //document.getElementById("txt_EmergencyName").value = document.getElementById("hdnEmergencyName").value;
                //document.getElementById("txt_telephone").value = document.getElementById("hdntelephone").value;
                //document.getElementById("txt_Relation").value = document.getElementById("hdnRelation").value;

                //EmployeeDetail
                //document.getElementById("txt_Id").value = document.getElementById("hdnEMPID").value;
                //document.getElementById("txt_witness").value = document.getElementById("hdnEmployeeName").value;
                ////document.getElementById("txt_telephone").value = document.getElementById("hdnEmpSignatureImage").value;
                //document.getElementById("imgEmpSign").src = document.getElementById("hdnEmpSignatureImage").value;

                //if (document.getElementById("hdnEmpSignatureImage").value == "../../Img/NoImage.jpg") {
                //    $("#EMPsign1").show();
                //    $("#EMPsign2").hide();
                //}
                //else {
            ...
            else if (document.getElementById("hdnFormName").value == "GENERAL CONSENT FORM") {
                debugger
                //alert(document.getElementById("hdnPatientName").value);
                document.getElementById("txtdate1").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate2").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate3").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
            ...
            else if (document.getElementById("hdnFormName").value == "INFORMED CONSENT PROCEDURES") {

                document.getElementById("txtdate1").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate2").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate3").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');
                document.getElementById("txtdate4").defaultValue = new Date().toJSON().slice(0, 10).replace(/-/g, '-');

                var date = new Date();
                var currentTime = date.getHours() + ':' + date.getMinutes();
                document.getElementById("txtTime1").value = currentTime;
                document.getElementById("txtTime2").value = currentTime;
                document.getElementById("txtTime3").value = currentTime;
                ...
                //document.getElementById("txtTime2").value = currentTime;
                //document.getElementById("txtTime3").value = currentTime;
                //document.getElementById("txtTime4").value = currentTime;

                document.getElementById("txt_FullPatName").value = document.getElementById("hdnFullPatName").value;
                document.getElementById("txt_MRN").value = document.getElementById("hdnMRN").value;
                document.getElementById("txt_Gender").value = document.getElementById("hdnGender").value;
                document.getElementById("txt_Age").value = document.getElementById("hdnAge").value;
                document.getElementById("txt_RegDate").value = document.getElementById("hdnRegDate").value; // Akshay_19072022_Tirathram
    ...
    <script type="text/javascript">
            $(document).ready(function () {
                var sign = $('#imageBox1').SignaturePad({
                    allowToSign: true,
                ...
                var sign = $('#imageBox2').SignaturePad({
                    allowToSign: true,
                    img64: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7',
                    border: '1px solid #c7c8c9',
                    width: '300px',
                ...
                var sign = $('#imageBox3').SignaturePad({
                    allowToSign: true,
                    img64: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7',
                    border: '1px solid #c7c8c9',
                    width: '300px',
                ...
                var sign = $('#imageBox4').SignaturePad({
                    allowToSign: true,
                    img64: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7',
                    border: '1px solid #c7c8c9',
                    width: '300px',
                ...
                var sign = $('#imageBox5').SignaturePad({
                    allowToSign: true,
                    img64: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7',
                    border: '1px solid #c7c8c9',
                    width: '300px',
...
<body onload="DateFill()">
    <form id="form1" runat="server">
         ...
         <asp:UpdatePanel ID="UpdatePanel4" UpdateMode="Conditional" runat="server" style="position: absolute; top: 36px;">
        <ContentTemplate>
        ...
        <div id="Form12" runat="server">    
        
       </div>
         </ContentTemplate>
    </asp:UpdatePanel>
           <textarea cols="50" rows="10" style="display:none"  id="txtDisplay"></textarea>
                            ...
                            <asp:HiddenField ID="hdnMRN" runat="server" />
                            
                            <asp:HiddenField ID="hdnFullPatName" runat="server" />
                            <asp:HiddenField ID="hdnEmergencyName" runat="server" />
                            <asp:HiddenField ID="hdntelephone" runat="server" />
                            <asp:HiddenField ID="hdnRelation" runat="server" />
          <asp:HiddenField ID="hdnFormName" runat="server" />
            <asp:HiddenField ID="hdnRegDate" runat="server" />  <%--Akshay_19072022_Tirathram--%>

        <%--EmployeeDetail--%>
        <asp:HiddenField ID="hdnEMPID" runat="server" />
        <asp:HiddenField ID="hdnEmployeeName" runat="server" />
        <asp:HiddenField ID="hdnEmpSignatureImage" runat="server" />

    
        <script type="text/javascript">
            function returnToParent(From) {
                window.opener.location = "TemplateNotesPrint.aspx?From=" + From +"";
                window.close();
            }
