...
public partial class EMR_Dashboard_PatientParts_PatientLabResult : System.Web.UI.UserControl
{
    ...
    protected void btnFilter_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMessage.Text = "<b>Please Select Dates ! </b>";
    ...
    private void bindMainData()
    {
        try
        {
            ...
            DataSet ds = objval.GetResultFinalization(common.myStr("OPD"), common.myInt(Session["HospitalLocationID"]),
                            ...
                            , 0, 0, 0, "", 0, 0, 0, "", 0, 0, "", 0, "", true, common.myInt(ddlEntrySitesActual.SelectedValue));
    ...
    {
        if (Session["SaveSignature"].ToString() == "Yes")
        {
            SetGridColor();
    ...
    protected void gvResultFinal_OnItemDataBound(object sender, GridItemEventArgs e)
    {
            ...
            || e.Item.ItemType == GridItemType.AlternatingItem)
        {
            ...
            if (common.myBool(lblAbnormalValue.Text) == true) // for abnormal
            {
                lblresult.ForeColor = System.Drawing.Color.DarkViolet;
            }
            if (common.myBool(lblCriticalValue.Text) == true) // for crotical
            {
    ...
    protected void gvResultFinal_OnItemCommand(object sender, GridCommandEventArgs e)
    {
        if (e.CommandName == "lnkResult")
        {
            ...
            //Label lblYearId = (Label)e.Item.FindControl("lblYearId");
