<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PatientLabResult.ascx.cs"
    Inherits="EMR_Dashboard_PatientParts_PatientLabResult" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" style="border: solid 1px #ccc">
    ...
    <tr>
        <td colspan="2">
            <asp:Panel ID="pnlPatientLabResult1" runat="server" SkinID="Panel" Width="750px">
                    ...
                    <telerik:RadGrid ID="gvResultFinal" runat="server" Width="100%" CssClass="RadGrid_Custom"
                        ...
                        <MasterTableView TableLayout="Fixed" GroupLoadMode="Client">
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="ResultDate" DefaultInsertValue="" HeaderText="Result Date"
                                    DataField="ResultDate" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                    ShowFilterIcon="false" AllowFiltering="false" FilterControlWidth="99%" Visible="True"
                                ...
                                <telerik:GridTemplateColumn UniqueName="ServiceName" DefaultInsertValue="" HeaderText="Lab Test"
                                    ...
                                    FilterControlWidth="99%" HeaderStyle-Width="30%" Visible="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Result" DefaultInsertValue="" HeaderText="Result"
                                    ...
                                    ShowFilterIcon="false" AllowFiltering="true" FilterControlWidth="99%" HeaderStyle-Width="20%"
                                    Visible="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="AbnormalValue" DefaultInsertValue="" HeaderText="AbnormalValue"
                                    DataField="AbnormalValue" SortExpression="AbnormalValue" AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn UniqueName="CriticalValue" DefaultInsertValue="" HeaderText="CriticalValue"
                                    DataField="CriticalValue" SortExpression="CriticalValue" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AllowFiltering="False"
                                    FilterControlWidth="99%" Visible="False">
                                    <ItemTemplate>
