<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PatientLabDashboard.ascx.cs"
    Inherits="EMR_Dashboard_PatientParts_PatientLabDashboard" %>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
    <tr>
        <td>
            ...
            <asp:TextBox ID="txtOrderId" runat="server" Style="visibility: hidden; position: absolute;" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="lblReviewedStatus" runat="server" SkinID="label" Text="Reviewed&nbsp;Staus" />
                    </td>
                    <td>
    ...
    <tr>
        <td>
            <asp:Panel ID="Panel1" runat="server" Width="950px" Height="280px" BorderWidth="0"
                ScrollBars="Auto">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDetails" ForeColor="#333333" runat="server" AllowPaging="True"
                            PageSize="9" SkinID="gridview" Width="99%" AutoGenerateColumns="False" CellPadding="0"
