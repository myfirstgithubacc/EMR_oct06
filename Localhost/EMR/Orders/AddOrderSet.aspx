<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrderSet.aspx.cs" Inherits="EMR_Orders_AddOrderSet" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="updMessage" runat="server">
            ...
            <div class="margin_bottom container-fluid header_main">
	            <div class="col-sm-3">
		            <h2><asp:Label ID="lblHeaderText" runat="server" Text=""></asp:Label></h2>
	            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <div class="col-sm-5"><asp:Label ID="Label2" runat="server" SkinID="label" Text="Order Set Name"></asp:Label></div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-7"> <telerik:RadComboBox ID="ddlProvider" runat="server"  Filter="StartsWith"
                          ...
                          <div class="col-sm-6 form-group">
                               <div class="col-sm-3">
                                     <asp:CheckBox ID="chkIsWardOrderSet" runat="server" AutoPostBack="true" OnCheckedChanged="chkIsWardOrderSet_CheckedChanged" Checked="false" Font-Bold="true" Text="Ward Order Set" CssClass="checkboxes" />
    
                                   </div>
                            <div class="col-sm-3">
                                                          <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" Text="Save" OnClick="btnSave_Click" /> 
                                <asp:Button ID="btnClose" CssClass="btn btn-primary" runat="server" Text="Close" OnClientClick ="window.close();" /></div>
                        ...
                        <td colspan="3">
                            <asp:Panel ID="pnlOrderSet" runat="server" ScrollBars="Vertical">
                                <asp:GridView ID="gvOrderSet" SkinID="gridview" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="100px" HeaderText="Order Set Name">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="10px">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnDoctorId" runat="server" Value='<%#Eval("DoctorId")%>' />
                                                 <asp:HiddenField ID="hdnIsWardOrderSet" runat="server" Value='<%#Eval("IsWardOrderSet")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                
                                 <asp:GridView ID="gvMedication" SkinID="gridview" runat="server" AutoGenerateColumns="false"
                                    Width="97%" ShowHeader="true" OnRowCommand="gvMedication_RowCommand" PageSize="20"
                                    PageIndex="0" PagerSettings-Mode="NumericFirstLast">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="100px" HeaderText="Medication Set Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSetName" runat="server" SkinID="label" Text='<%#Eval("SetName")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="10px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" OnClick="lnkEditMedication_OnClik"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-Width="10px">
                                            <ItemTemplate>
