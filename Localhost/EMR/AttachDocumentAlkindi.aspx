<%@ Page Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master" Trace="false"
    AutoEventWireup="true" CodeFile="AttachDocumentAlkindi.aspx.cs" Inherits="EMR_AttachDocument"
    Title="" %>
...
<%@ Register TagPrefix="asplNurse" TagName="UserDetailsHeader" Src="~/Include/Components/TopPanelNurse.ascx" %>
    ...
    <div class="VisitHistoryDiv">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:Button ID="ibtnClose" runat="server" CssClass="SearchKeyBtn01" Text="Close" ToolTip="Close" OnClientClick="window.close();" />
                    <asp:Button ID="btnUpload" runat="server" CssClass="SearchKeyBtn01" Text="Upload (F3)" ValidationGroup="save" OnClick="btnUpload_Click" />
                    <asp:Button ID="btnNew" runat="server" CssClass="SearchKeyBtn01" ToolTip="New" Visible="false" Text="New" OnClick="btnNew_Click" />
                    &nbsp;
                    <asp:Button ID="btnNo" runat="server" ToolTip="Close" SkinID="Button" Text="Close (F8)" CausesValidation="false" Visible="false" OnClick="btnNo_OnClick" />
                                        ...
                                        <div class="VitalHistory-Div">
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="EMRUploadDiv">
                                                            <h2>File Upload <span class="red">*</span></h2>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="EMRUploadDiv">
                                                            <h2>Category <span class="red">*</span></h2>
                                                            <asp:DropDownList ID="ddlCategory" runat="server" Width="200px">
                                                                <asp:ListItem Text="Select" Value="" />
                                                            </asp:DropDownList>
                                                            &nbsp;
                                                     <h4>
                                                         <asp:Button ID="btnDocumentCategory" runat="server" Text="New Category" ToolTip="New Category" Visible="true" CssClass="SearchKeyBtn01b" CausesValidation="false" OnClick="btnDocumentCategory_Click" /></h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="EMRUploadDiv">
                                                            <h2>File Name <span class="red">*</span></h2>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="EMRUploadDiv">
                                                            <h2>Remarks</h2>
                                                            <asp:TextBox ID="txtRemarks" runat="server" MaxLength="200" Text='<%#Eval("Remarks") %>' />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="EMRUploadDiv01">
                                                            ...
                                                            <asp:TextBox ID="txtDate" runat="server" Columns="10"></asp:TextBox>
                                                            ...
                                                            <h3>Visit No</h3>
                                                            <asp:DropDownList ID="ddlvisit" runat="server"></asp:DropDownList>
