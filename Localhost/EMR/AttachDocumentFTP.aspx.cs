...
public partial class EMR_AttachDocumentFTP : System.Web.UI.Page
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        ...
        else if (Request.QueryString["OTBooking"] != null)
        {
            if (Request.QueryString["OTBooking"].ToString() == "Yes")
            {
                Page.MasterPageFile = "/Include/Master/BlankMaster.master";
            }
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (common.myStr(Request.QueryString["Usefor"]).Equals("MRD"))
        {
            divRiscticted.Visible = true;
            btnNew.Visible = true;
        }
        bool x = btnUpload.Visible;

        if (Request.QueryString["OTBooking"] != null)
        {
            if (Request.QueryString["OTBooking"].ToString() == "Yes")
            {
        ...
        lbtnSearchPatient.Text = common.myStr(Session["RegistrationLabelName"]);
        if (!IsPostBack)
        {
            if (common.myStr(Request.QueryString["MASTER"]) == "No")
            {
        ...
        try
        {
            if (Session["HospitalLocationID"] != null)
            {
                ...
                if (txtRegNo.Text == "")
                {
                    ...
                    if (common.myStr(Request.QueryString["Usefor"]).Equals("MRD"))
                    {
                        hstInput.Add("@intEmployeeId", Convert.ToInt16(Session["UserID"]));
                    }
    ...
    protected void btnDocumentCategory_Click(object sender, EventArgs e)
    {
        ...
        RadWindowForNew.Behaviors = WindowBehaviors.Maximize | WindowBehaviors.Minimize | WindowBehaviors.Close | WindowBehaviors.Pin | WindowBehaviors.Resize;
            ...
            if (Session["HospitalLocationId"] != null)
            {
                ...
                if (_FileUpload.FileName != "")
                {
                    ...
                    else
                    {
                        ...
                        objStr.Append("</c1>");
                        objStr.Append("<c2>");
                        objStr.Append(objParse.ParseQ(txtDescription.Text) + '-' + txtDate.Text);
                        objStr.Append("</c2>");
                        objStr.Append("<c3>");
                        ...
                        if (objStr.ToString() != "")
                        {
                            ...
                            using (SqlConnection objCon = new SqlConnection(sConString))
                            {
                                using (SqlCommand objCmd = new SqlCommand("UspSavePatientDocuments", objCon))
                                {
                                    ...
                                    objCmd.Parameters.AddWithValue("@bitIsFileRestricted", chkFileRestricted.Checked ? "1" : "0");
    ...
    private void UploadtoFTP(FileUpload FileUpload1, string fileName)
    {
        ...
        try
        {
            FtpWebRequest ftpClient = (FtpWebRequest)FtpWebRequest.Create(ftppath.Split(csplitter)[0].ToString() + Rootfolder + Session["HospitalLocationID"].ToString() + "/" + txtRegNo.Text + "/" + fileName);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            String isauthorizetodelete = string.Empty;
            ...
            isauthorizetodelete = common.myStr(objSecurity.CheckUserRights(common.myInt(Session["HospitalLocationID"]), common.myInt(Session["EmployeeId"]), common.myInt(Session["FacilityId"]), "AllowDocumentDeletePermission"));
            if (common.myStr(isauthorizetodelete).ToUpper().Contains("TRUE") || common.myStr(isauthorizetodelete).ToUpper().Contains("1"))
            {
    ...
    protected void btnGetInfo_Click(object sender, EventArgs e)
    {
        ...
        //   Response.Redirect("AttachDocument.aspx?MASTER=No&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
        ...
        if (Request.QueryString["Nurse"] != null)
        {
            if (common.myStr(Request.QueryString["Nurse"]) != string.Empty)
            {
                if (common.myStr(Request.QueryString["Nurse"]) == "1")
                {
                    ...
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        Response.Redirect("AttachDocument.aspx?Reg=1&Nurse=1&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
                    else
                        Response.Redirect("AttachDocumentFTP.aspx?Reg=1&Nurse=1&Usefor=" + ViewState["Usefor"] + "&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
                }
                else
                {
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        ...
                        Response.Redirect("AttachDocumentFTP.aspx?MASTER=No&Usefor=" + ViewState["Usefor"] + "&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
            ...
            {
                if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                    Response.Redirect("AttachDocument.aspx?RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
                else
                    Response.Redirect("AttachDocumentFTP.aspx?Usefor=" + ViewState["Usefor"] + "&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
        ...
        else if (Request.QueryString["Reg"] != null)
        {
            if (common.myStr(Request.QueryString["Reg"]) != string.Empty)
            {
                ...
                {
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        Response.Redirect("AttachDocument.aspx?Reg=1&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
                    else
                        Response.Redirect("AttachDocumentFTP.aspx?Reg=1&Usefor=" + ViewState["Usefor"] + "&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
    ...
    private string displayimage(string filename)
    {
        string returnfile = "";
        try
        {
            ...
            //Create FTP Request.
            FtpWebRequest request = (FtpWebRequest)WebRequest.Create(ftppath.Split(csplitter)[0].ToString() + Rootfolder + Session["HospitalLocationID"].ToString() + "/" + txtRegNo.Text + "/" + filename);
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                string docPath = Server.MapPath("~/PatientDocuments/" + filename);
    ...
    protected void lbtnDownload_OnClick(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = displayimage(btndownload.CommandArgument);
            string path = filename;
            System.IO.FileInfo file = new System.IO.FileInfo(path);
            if (file.Exists)
            {
                Response.Clear();
                Response.AddHeader("Content-Disposition", "attachment; filename=" + btndownload.CommandArgument);
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        if (filename == Convert.ToString(ds.Tables[0].Rows[i]["ImageName"].ToString()))
                        {
                            ...
                            else
                            {
                                ...
                                string sFileName = displayimage(filename);// Server.MapPath("/PatientDocuments/" + common.myStr(Session["HospitalLocationID"]) + "/" + common.myStr(txtRegNo.Text).Trim() + "/" + filename);
            ...
            if (common.myStr(Request.QueryString["Nurse"]) != string.Empty)
            {
                if (common.myStr(Request.QueryString["Nurse"]) == "1")
                {
                    ...
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        ...
                        Response.Redirect("AttachDocumentFTP.aspx?Reg=1&Nurse=1&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
                }
                else
                {
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        ...
                        Response.Redirect("AttachDocumentFTP.aspx?MASTER=No&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
            ...
            if (common.myStr(Request.QueryString["Reg"]) != string.Empty)
            {
                if (common.myStr(Request.QueryString["Reg"]) == "1")
                {
                    if (common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationId"]), common.myInt(Session["FacilityId"]), "UseFTPAttachDocument", sConString).Equals("N"))
                        ...
                        Response.Redirect("AttachDocumentFTP.aspx?Reg=1&RNo=" + txtAccountNo.Text.ToString().Trim() + "", false);
