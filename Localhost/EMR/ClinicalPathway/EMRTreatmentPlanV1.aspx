<%@ Page Title="" Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master" AutoEventWireup="true" 
    CodeFile="EMRTreatmentPlanV1.aspx.cs" Inherits="EMR_ClinicalPathway_EMRTreatmentPlanV1"  MaintainScrollPositionOnPostback="true"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function OnClientCloseCopy(oWnd, args) {
            ...
            if (arg) {
                $get('<%=hdnSelectedPlanId.ClientID%>').value = arg.PlanId;
                $get('<%=hdnSelectedDayDetailId.ClientID%>').value = arg.SelectedDayDetailId;
                $get('<%=hdnSelectedDayId.ClientID%>').value = arg.SelectedDayId;
                $get('<%=btnRefreshCopy.ClientID%>').click();
            }
        }
...
.gv-selected-service .head-greybg td { padding-left: 0;}
        ...
        .form-group.col-md-6 label span:first-child {
            float: left;
            margin-right: 5px;
        }
    </style>
    ...
    <div id="dvScroll"  style="overflow-y: scroll; height: 600px; width: 99%">
        ...
        <div class="container-fluid">
            ...
            <div class="row bg-info" style="padding: 5px;">
                <div>
                    <div class="col-md-4"><b>Care Plan</b></div>
                    <div class="col-md-8 text-right">
                        <telerik:RadComboBox ID="ddlEnteredDayData" runat="server" class="form-control" MarkFirstMatch="true" Filter="Contains" EnableLoadOnDemand="true"
                            EmptyMessage="[Select" Visible="false" EnableVirtualScrolling="true" Style="padding: 2px 10px !important" Width="200px" />
                        <asp:Button ID="btnCopy" runat="server" OnClick="btnCopy_Click" Text="Copy" Visible="false" CssClass="btn btn-primary btn-sm" Style="margin-right: 10px;" />


                        <asp:LinkButton ID="btnAddPlaneName" runat="server" Text="Add Plan" CssClass="btn btn-primary btn-sm"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <label>
                                                <asp:Label ID="lblDept" runat="server" Text="Plan Name" /><asp:Label ID="lblTitle" runat="server" Text="*" ForeColor="Red" /></label>
                                            <telerik:RadComboBox ID="ddlPlanTemplates" runat="server" class="form-control" MarkFirstMatch="true" Filter="Contains" EnableLoadOnDemand="true"
                                             ...
                                             &nbsp;&nbsp;<asp:Label ID="lblPlanMessage" runat="server" Text="" CssClass="top-error" />
                                        </div>
                                        <div class="panel-body">
                                            <div class="form-group">

                                                <div class="day-lbl">
                                                    <asp:Label ID="Label8" runat="server" Text="Day" /><asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red" /></div>
                                                <div class="pull-left">
                                                    <asp:DataList ID="GridViewdays" CssClass="table table-condensed" runat="server" CellPadding="10"
                            ...
                            <div class="row">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <telerik:RadComboBox ID="ddlSpecilizationNew" runat="server" AppendDataBoundItems="true"
                                                    MaxHeight="220px" Width="30%" EmptyMessage="Search by Text" />
                                            ...
                                            <asp:GridView ID="gvSpecialsation" runat="server" SkinID="gridviewOrderNew" OnRowCommand="gvSpecialsation_RowCommand"
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <asp:GridView ID="gvDrugClass" runat="server" SkinID="gridviewOrderNew" OnRowCommand="gvDrugClass_RowCommand"
                                                        HeaderStyle-HorizontalAlign="Right" HeaderStyle-ForeColor="#15428B" HeaderStyle-Height="25px"
                                                        HeaderStyle-Wrap="false" HeaderStyle-BackColor="#eeeeee" HeaderStyle-BorderColor="#ffffff" HeaderStyle-BorderWidth="0"
                                                        AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" CssClass="table table-bordered">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText='<%$ Resources:PRegistration, SerialNo%>' FooterStyle-HorizontalAlign="Right" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15px">
                                                                <ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="13px" HeaderText="" ItemStyle-Width="30px">
                                                                <ItemTemplate>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <div class="row">
                                                        <label class="col-md-3">
                                                            <asp:Label ID="Label14" runat="server" Text="Generic Name" /></label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="row">
                                                        <label class="col-md-3">
                                                            <asp:Label ID="lblItemName" runat="server" Text="Brand Name" /><asp:Label ID="Label3" runat="server" Text="*" ForeColor="Red" /></label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="row">
                                                        <label class="col-md-3">
                                                            <asp:Label ID="lblFrequency" runat="server" Text="Frequency" /><asp:Label ID="Label4" runat="server" Text="*" ForeColor="Red" /></label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="row">
                                                        <label class="col-md-3">
                                                            <asp:Label ID="lblDays" runat="server" Text="Duration" MaxLength="3" /><asp:Label ID="Label5" runat="server" Text="*" ForeColor="Red" /></label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="row">
                                                        <label class="col-md-3">
                                                            <asp:Label ID="lblDose1" runat="server" Text="Dose" /><asp:Label ID="Label6" runat="server" Text="*" ForeColor="Red" /></label>

                                                        <div class="col-md-9">
                                                            <asp:TextBox ID="txtDose" Width="28%" Height="28px" runat="server" CssClass="Textbox" MaxLength="4" />
                                            ...
                                            <asp:GridView ID="gvPrescription" runat="server" SkinID="gridviewOrderNew" OnRowCommand="gvPrescription_RowCommand"
                                                HeaderStyle-HorizontalAlign="Right" HeaderStyle-ForeColor="#15428B" HeaderStyle-Height="25px"
                                                HeaderStyle-Wrap="false" HeaderStyle-BackColor="#eeeeee" HeaderStyle-BorderColor="#ffffff" HeaderStyle-BorderWidth="0"
                                                AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" CssClass="table table-bordered">
                                                <Columns>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <asp:GridView ID="gvTemplateLis" runat="server" SkinID="gridviewOrderNew"
                                                    ...
                                                    OnRowCommand="gvTemplateLis_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText='<%$ Resources:PRegistration, SerialNo%>'
                                                            FooterStyle-HorizontalAlign="Right" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15px">
                                                            <ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="60px" HeaderText="">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ibtnDelete" runat="server" ToolTip="Click here to delete this record"
                                                                    CommandName="ItemDelete" CausesValidation="false" CommandArgument='<%#Eval("Id")%>'
                                                                    ImageUrl="~/Images/DeleteRow.png" Width="13px" Height="13px" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default checkbox-panel">
                                        ...
                                        <div class="panel-body panel-info" style="padding: 8px 0;">
                                            <div class="">
                                                <div class="row1">
        ...
        <asp:Button ID="btnRefreshCopy" runat="server" OnClick="btnRefreshCopy_Click" Text="Copy" Style='visibility: hidden' />
