...
public partial class EMRReports_PrintHealthCheckUp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
                sbTitle.Append("<table cellpadding='0' cellspacing='0'><tr ><td valign='top' align='center' style='border-style:none;font-size:10pt;font-weight:bold;font-family: Arial;text-decoration: underline;'>" + common.myStr(ds.Tables[0].Rows[0]["HeadingName"]) + "</td></tr></table>");
            else
                sbTitle.Append("<table cellpadding='0' cellspacing='0'><tr ><td valign='top' align='center' style='border-style:none;font-size:10pt;font-weight:bold;font-family: Arial;text-decoration: underline;'>Discharge Summary</td></tr></table>");

            #endregion
            #region Header table
            string Fonts = getFontName("1", "10"); //getFontName("2", "11");
                        ...
                        if (dtR.Rows.Count != 0)
                        {
                            ...
                            for (int c = 1; c <= dtR.Rows.Count; c++)
                            {
                                if (!Convert.ToBoolean(dsHead.Tables[0].Rows[cc]["IsBinary"]))
                                {
                                    ...
                                    {
                                        if (dtR.Rows.Count == 1 && common.myStr(dsHead.Tables[0].Rows[cc]["FieldCaption"]).ToUpper().Equals("ADDRESS"))
                                        {
                                            sb.Append("<td align='left' colspan='2' valign='top' style='border-style:none;font-size:10pt; font-weight:bold;'>" + dsHead.Tables[0].Rows[cc]["FieldCaption"].ToString() + ": " + dsHead.Tables[0].Rows[cc]["Value"].ToString() + "</td>");
                                        }
                                        else
                                        {
                                    ...
                                    {
                                        sb.Append("<td align='left' style='border-style:none;font-size:10pt; font-weight:bold;'>: " + dsHead.Tables[0].Rows[cc]["Value"].ToString() + "</td>");
                                    }
                                }
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        sb.Append("<td align='left' style='border-style:none;font-size:10pt; font-weight:bold;'><u>" + "<td valign='top' ><img src='/PatientDocuments/PatientImages/BioChem.bmp' border='0'></img></td>" + "</u></td>");
                                    }
                                }
                                cc++;
                        ...
                        if (dtR.Rows.Count != 0)
                        {
                            ...
                            for (int c = 1; c <= dtR.Rows.Count; c++)
                            {
                                if (!Convert.ToBoolean(dsHead.Tables[0].Rows[cc]["IsBinary"]))
                                {
                                    if (dtR.Rows.Count == 1 && common.myStr(dsHead.Tables[0].Rows[cc]["FieldCaption"]).ToUpper().Equals("ADDRESS"))
                                    {
                                        sb.Append("<td align='left' colspan='2' valign='top' style='border-style:none;font-size:10pt; font-weight:bold;'>" + dsHead.Tables[0].Rows[cc]["FieldCaption"].ToString() + " - " + dsHead.Tables[0].Rows[cc]["Value"].ToString() + "</u></td>");
                                    }
                                    else
                                    {
                                ...
                                {
                                    sb.Append("<td align='left' style='border-style:none;font-size:10pt; font-weight:bold;'>:" + dsHead.Tables[0].Rows[cc]["FieldCaption"].ToString() + " - " + "<td valign='top' ><img src='/PatientDocuments/PatientImages/BioChem.bmp' border='0'></img></td>" + "</u></td>");
                                }
                                cc++;
                            }
                            sb.Append("</tr>");
            ...
            sb1.Append("<table width='96%' border='0' cellpadding='0' cellspacing='0' style='font-size:10pt;font-family:Arial;'>");
            sb1.Append("<tr><td align='right'>");
            sb1.Append("<br />");
            sb1.Append("</td></tr>");
            sb1.Append("</table>");
            string ShowHeaderDepartNameonMedicalSummary = common.GetFlagValueHospitalSetup(common.myInt(Session["HospitalLocationID"]), common.myInt(Session["FacilityId"]), "ShowHeaderDepartMentNameonMedicalSummary", sConString);
            if (ShowHeaderDepartNameonMedicalSummary == "Y")
            {
                StringBuilder sbDepart = new StringBuilder();
                sbDepart.Append("<table cellpadding='0' cellspacing='0'><tr ><td valign='top' align='center' style='border-style:none;font-size:10pt;font-weight:bold;font-family: Arial;'>DEPARTMENT OF " + common.myStr(ViewState["DepartmentName"]).ToUpper() + "</td></tr></table>");
                sbtopheader.Append(sbDepart + "");
                sbtopheader.Append(sbTitle + "<br/>");
                sbtopheader.Append("<hr>");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                sbPatientSummary = sbPatientSummary.Replace("font-weight: 700; font-family: courier new;", "font-size:10pt; font-family: Arial; font-weight:bold;");
                sbPatientSummary = sbPatientSummary.Replace("font-weight: 700;", "font-size:10pt;");

                sbPatientSummary = sbPatientSummary.Replace("font-size: 16px; font-family: &quot;microsoft sans serif&quot;;", "font-size: 10pt; font-family: Arial;");
                sbPatientSummary = sbPatientSummary.Replace("font-size: 16px; font-family: &quot;segoe ui&quot;;", "font-size: 10pt; font-family: Arial;");
                sbPatientSummary = sbPatientSummary.Replace("font-family: &quot;segoe ui&quot;;", " font-family: Arial;");
                ...
                sbPatientSummary = sbPatientSummary.Append("<span style='font-size:10pt; font-family: Arial; '>" + sbPS.ToString() + "</span>");
                ...
                cPrint.HeaderHtml = sbNextHeader.ToString(); //sb.ToString() + sb1.ToString();
    ...
    private string GetSignatureDetails()
    {
        ...
        if (common.myInt(ViewState["SignDoctorID"]) > 0)
        {
            ...
            sbSign.Append("<table cellspacing='0' cellpadding='0' border='0' style='font-family: Arial;font-size:10pt;'>");
            sbSign.Append("<tr><td></td><td></td><td></td><td></td><td></td></tr>");

            sbSign.Append("<tr>");
            sbSign.Append("<td></td><td></td>");
            sbSign.Append("<td colspan='3' align='right' style='font-family: Arial;font-size:10pt;'>");
            ...
            sbSign.Append("<tr>");
            sbSign.Append("<td></td><td></td>");
            sbSign.Append("<td colspan='3' valign='top' align='right' style='font-family: Arial;font-size:10pt; font-weight: bold;'>");
            //sbSign.Append(common.myStr(ViewState["SignDoctorName"]).Trim() + " " + ", <SPAN style='font-family: Arial;font-size:9pt;'>" + common.myStr(ViewState["Education"]).Trim() + "</SPAN>");
            sbSign.Append(common.myStr(ViewState["SignDoctorName"]).Trim());

            sbSign.Append("</td>");
            sbSign.Append("</tr>");

            if (!common.myStr(ViewState["Education"]).Trim().Equals(string.Empty))
            {
                sbSign.Append("<tr>");
                sbSign.Append("<td></td><td></td>");

                sbSign.Append("<td colspan='3' valign='top' align='right' style='font-family: Arial;font-size:9pt;'>");
            ...
            //sbSign.Append("<td colspan='3' align='right' style='font-family: Courier New;font-size:9pt;'>");
            ...
            {
                sbSign.Append("<tr>");
                sbSign.Append("<td colspan='5' valign='top' align='right' style='font-family: Arial;font-size:9pt;' >Prepared By : " + common.myStr(ViewState["PreparedByName"]) + "</td>");
                sbSign.Append("</tr>");
            }
    ...
    private void getDoctorImage()
    {
        ...
        try
        {
            if (common.myInt(ViewState["SignDoctorID"]) > 0)
            {
                ...
                {
                    hdnDoctorImage.Value = DivStartTag + "<table  border='0' cellpadding='0' cellspacing='0' style='font-size:10pt; font-family:Arial;'><tbody><tr><td></td><td></td><td></td><td colspan='3'  align='right'>" + SignImage + "</td></tr></tbody></table><br />";
                }
            }
        }
        catch (Exception ex)
    ...
    public StringBuilder AddTopHeader(string DepartmentId, string ConsultingDoctorDepartment, string EntrySite)
    {
        ...
        sbTopHeader.Append("<table cellpadding='2' cellspacing=1 style='border-style:none;font-size:10pt;font-weight:bold;font-family:Arial;'>");
