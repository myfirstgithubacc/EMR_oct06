<%@ Page Title="" Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master"
    AutoEventWireup="true" CodeFile="AppScheduler.aspx.cs" Inherits="Appointment_AppScheduler_New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../Include/JS/jquery1.11.3.js" type="text/javascript"></script>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ADLeft">
                                <div class="AD-leftPart">
                                    ...
                                    <div class="AdLeft-Calender col-md-12 col-6">
                            ...
                            <div class="col-md-1 col-3 ADLeft">
                                <div class=" row">
                                    <div class="col-md-12">
                                ...
                                <div class="App-Summary">
                                    ...
                                    <div class="AS-chartY col-md-12 " onclick="OnClientNewAppointment(this)">
                                    ...
                                    <div class="AS-chartG col-md-12" onclick="OnClientAppointment(this)">
                                        <div class="AS-chart-left">
                                            <h3>
                                    ...
                                    <div class="AS-chartP col-md-12" onclick="OnClientConfirmdAppointment(this)">
                                        <div class="AS-chart-left">
                                            <h3>
                                    ...
                                    <div class="AS-chartGreen col-md-12" onclick="OnClientCheckedInAppointment(this)">
                                        <div class="AS-chart-left">
                                            <h3>
                                    ...
                                    <div class="AS-chartPink col-md-12" onclick="OnClientCancelleddAppointment(this)">
                                        <div class="AS-chart-left">
                                            <h3>
                                    ...
                                    <div class="AS-chartPayment col-md-12" onclick="OnClientPaymentAppointment();">
                                        <div class="AS-chart-left">
                                            <h3>
                        ...
                        <div class="row">
                            <telerik:RadWindowManager ID="RadWindowManager" EnableViewState="false" runat="server">
                                <Windows>
                                    <telerik:RadWindow ID="RadWindowForNew" runat="server" Skin="Office2007" Behaviors="Close"></telerik:RadWindow>
                                </Windows>
