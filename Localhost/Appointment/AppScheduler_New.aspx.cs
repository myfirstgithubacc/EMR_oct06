...
public partial class Appointment_AppScheduler_New : System.Web.UI.Page
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(common.myStr(Request.QueryString["DAYS"])))
        {
            followUpDays = 0;
        ...
        {
            followUpDays = common.myInt(Request.QueryString["DAYS"]);
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtpDate.TodaysDate = today.AddDays(followUpDays);
                //  dtpDate.SelectedDate = dtpDate.TodaysDate;

                dtpDate.SelectedDate = today.AddDays(followUpDays);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ViewState["SELECTED_DATE"] = common.myDate(DateTime.UtcNow).AddMinutes(timezone).AddDays(followUpDays);
                    }
                    else
                    {
               ...
               // dtpDate.SelectedDate = Convert.ToDateTime(ViewState["SELECTED_DATE"]);
                ...
                string x = ddlSpecilization.Text;
    ...
    private void BindControlForFollowUpAppointment()
    {
        ...
        else
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlSpecilization.SelectedIndex = ddlSpecilization.Items.IndexOf(ddlSpecilization.Items.FindItemByValue(common.myStr(ds.Tables[0].Rows[0]["SpecializationId"])));
    ...
    private void BindSpeciliazation()
    {
        ...
        try
        {
            ...
            if (dsSpeciliazation.Tables[0].Rows.Count > 0)
            {
                ...
                BindControlForFollowUpAppointment();
                //BaseC.Appointment app = new BaseC.Appointment(sConString);
                //DataSet dsApp = app.getDoctorSpecialization(Convert.ToInt16(Session["HospitalLocationId"]), Convert.ToInt16(Session["DoctorId"]));
                //if (dsApp.Tables[0].Rows.Count > 0)
                //{
                //    ddlSpecilization.SelectedIndex = ddlSpecilization.Items.IndexOf(ddlSpecilization.Items.FindItemByValue(common.myStr(dsApp.Tables[0].Rows[0]["SpecializationId"])));
                //}
    ...
    protected void btnFindNext_Click(object sender, EventArgs e)
    {
        ...
        RadWindowForNew.NavigateUrl = "~/Appointment/ViewNextTimeSlot.aspx";
    ...
    {
        //if (Request.QueryString["Mpg"].ToString() == "P781")
        //{
        //    RadWindowForNew.NavigateUrl = "~/Appointment/ViewProviderTimings.aspx?Mpg=P781";
        //}
        //else
        //{
        RadWindowForNew.NavigateUrl = "~/Appointment/ViewProviderTimings.aspx";
        //}
    ...
    protected void btnClear_OnClick(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/Appointment/AppScheduler_New.aspx?MASTER=NO", false);
        }
        else
        {
            Response.Redirect("~/Appointment/AppScheduler_New.aspx", false);
        }
    }
        ...
        try
        {
            if (RadScheduler1.Resources.Count != 0)
            {
                ...
                if (e.MenuItem.Value == "New")
                {
                    ...
                    if (ddlFacility.SelectedValue == "0")
                    {
                        navstr = "~/Appointment/AppointmentDetails.aspx?FacilityId=" + e.TimeSlot.Resource.Key +
                            "&StTime=" + e.TimeSlot.Start.Hour.ToString() + "&EndTime=" + RadScheduler1.DayEndTime.Hours.ToString() + "&appDate=" + e.TimeSlot.Start.ToString("dd/MM/yyyy") + "&appid=0&doctorId=" + RadLstDoctor.SelectedValue + "&TimeInterval=" + RadScheduler1.MinutesPerRow.ToString() + "&FromTimeHour=" + e.TimeSlot.Start.Hour.ToString() + "&FromTimeMin=" + e.TimeSlot.Start.Minute.ToString() + "&PageId=" + Request.QueryString["Mpg"] + "&IsDoctor=" + IsDoctor;
                        ViewState["FacilityId"] = e.TimeSlot.Resource.Key;
                    }
                    else
                    {
                        navstr = "~/Appointment/AppointmentDetails.aspx?FacilityId=" + ddlFacility.SelectedValue
                ...
                else if (e.MenuItem.Value == "Break")
                {
                    ...
                    if (dtTemp != null)
                    {
                        RadWindowForNew.NavigateUrl = "~/Appointment/BreakAndBlock.aspx?Category=PopUp&FacilityId=" + ddlFacility.SelectedValue + "&StTime=" + e.TimeSlot.Start.Hour.ToString() + "&EndTime=" + RadScheduler1.DayEndTime.Hours.ToString() + "&appDate=" + e.TimeSlot.Start.ToString("MM/dd/yyyy") + "&appid=0&DoctorId=" + e.TimeSlot.Resource.Key + "&TimeInterval=" + RadScheduler1.MinutesPerRow.ToString() + "&FromTimeHour=" + e.TimeSlot.Start.Hour.ToString() + "&FromTimeMin=" + e.TimeSlot.Start.Minute.ToString() + "&PageId=" + Request.QueryString["Mpg"] + "&recrule=" + null + "&IsDoctor=" + IsDoctor;
                ...
                {
                    RadWindowForNew.NavigateUrl = "~/Appointment/DoctorProfile.aspx?resounceId=" + common.myInt(resounceId);
            ...
            else
            {
                ...
                if (e.MenuItem.Value == "Edit")
                {
                    ...
                    if (isBreak == true)
                    {
                        ...
                        RadWindowForNew.VisibleOnPageLoad = true; // Set this property to True for showing window from code    
                        RadWindowForNew.VisibleStatusbar = false;
                        //Response.Redirect("~/Appointment/BreakAndBlock.aspx?DoctorID=" + dtLunch.Rows[0]["DoctorID"].ToString());//?StTime=" + RadScheduler1.DayStartTime.Hours.ToString() + "&EndTime=" + RadScheduler1.DayEndTime.Hours.ToString() + "&appDate=" + e.Appointment.Start.Date.ToString("MM/dd/yyyy") + "&appid=" + strAppId[0] + "&RecRule=" + recrule + "&recparentid=" + recparentid + "&doctorId=" + e.Appointment.Resources[0].Key + "&TimeInterval=" + RadScheduler1.MinutesPerRow.ToString() + "&AppId1=" + e.Appointment.ID.ToString() + "&PageId=" + "Mpg=P3" + "&IsDoctor=" + IsDoctor;
                    }
                    else
                    {
                        bool IsDoctor = false;
                    ...
                    if (isBreak != true)
                    {
                        ...
                        if (intStatusID.ToString() != "1")
                        {
                            if (common.myInt(sEncounterId) > 0)
                            {
                                ...
                                //if (e.MenuItem.Value == "PC")
                                //{
                                Response.Redirect("~/EMRBILLING/OPBill.aspx?DoctorId=" + e.Appointment.Resources[0].Key + "&RegNo=" + strRegNo + "&EncId=" + common.myInt(sEncounterId) + "&IsAppoint=1" + "&AppointmentId=" + strAppId[0] + "&PackageId=" + common.myInt(e.Appointment.Attributes["PackageId"]) + "&PackageType=" + common.myStr(e.Appointment.Attributes["PackageType"]), false);
    ...
    protected void btnbtnprint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RadWindowForNew.NavigateUrl = "/Appointment/PrintAppointmentschedule.aspx?FacilityName=" + ddlFacility.SelectedItem.Text + "&ProviderName=" + ViewState["docname"].ToString() + "&Appdate=" + CalApp.SelectedDate.Date.ToString("yyyy/MM/dd") + "&DocId=" + Convert.ToInt32(ViewState["DocId"]) + "&FacId=" + ddlFacility.SelectedValue + "";
            RadWindowForNew.NavigateUrl = "/Appointment/PrintAppointmentschedule.aspx?FacilityName=" + ddlFacility.SelectedItem.Text + "&ProviderName=" + Convert.ToString(ViewState["docname"]) + "&Appdate=" + dtpDate.SelectedDate.ToString("yyyy/MM/dd") + "&DocId=" + Convert.ToString(ViewState["DocId"]) + "&FacId=" + ddlFacility.SelectedValue + "";
    ...
    protected void btnMakeAppointment_Click(object sender, EventArgs e)
    {
        ...
        navstr = "~/Appointment/AppointmentDetails.aspx?FacilityId=" + common.myStr(ViewState["FacilityId"]) +
            "&StTime=" + common.myStr(ViewState["StTime"])
            + "&EndTime=" + common.myStr(ViewState["EndTime"])
    ...
    protected void Status_OnClick(object sender, EventArgs e)
    {
        ...
        RadWindowForNew.NavigateUrl = "/Appointment/AppointmentDetailsList.aspx?StatusId=" + common.myInt(sId) +
    ...
    {
        RadWindowForNew.NavigateUrl = "/Appointment/OnlineAppointmentRequest.aspx?doctorId=0&useFor=Display";
        RadWindowForNew.Top = 40;
        RadWindowForNew.Left = 100;
    ...
    {
        RadWindowForNew.NavigateUrl = "~/Appointment/SearchAppointment.aspx";
        RadWindowForNew.Height = 600;
    ...
    protected void lnkAppointment_OnClick(object sender, EventArgs e)
    {
        ...
        RadWindowForNew.NavigateUrl = "~/Appointment/PatientDetails.aspx?Date=" + dtpDate.SelectedDate.ToString("yyyy/MM/dd") + "&Provider=" + common.myStr(strProvider) + "&DateOption=" + common.myStr(ViewState["CurrentView"]) + "&Status=" + Status;
        RadWindowForNew.Height = 550;
        RadWindowForNew.Width = 750;
        RadWindowForNew.Top = 40;
        RadWindowForNew.Left = 100;
    ...
    protected void lnkNewPatient_OnClick(object sender, EventArgs e)
    {
        ...
        //  RadWindowForNew.NavigateUrl = "~/Appointment/SearchAppointment.aspx?Date=" + dtpDate.SelectedDate.ToString("yyyy/MM/dd") + "&DateOption=" + common.myStr(ViewState["CurrentView"]) + "&Status=" + Status;
        RadWindowForNew.NavigateUrl = "~/Appointment/PatientDetails.aspx?Date=" + dtpDate.SelectedDate.ToString("yyyy/MM/dd") + "&Provider=" + common.myStr(strProvider) + "&DateOption=" + common.myStr(ViewState["CurrentView"]) + "&Status=" + Status;
        RadWindowForNew.Height = 550;
        RadWindowForNew.Width = 750;
        RadWindowForNew.Top = 40;
    ...
    protected void lnkConfirmed_OnClick(object sender, EventArgs e)
    {
        ...
        RadWindowForNew.NavigateUrl = "~/Appointment/PatientDetails.aspx?Date=" + dtpDate.SelectedDate.ToString("yyyy/MM/dd") + "&DateOption=" + common.myStr(ViewState["CurrentView"]) + "&Status=" + Status;
        RadWindowForNew.Height = 550;
        RadWindowForNew.Width = 750;
        RadWindowForNew.Top = 40;
        RadWindowForNew.Left = 100;
