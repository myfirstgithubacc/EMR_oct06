<%@ Page Title="" Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master"
    AutoEventWireup="true" CodeFile="AppSchedulerV1.aspx.cs" Inherits="Appointment_AppSchedulerV1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <link href="../Include/css/Appointment.css" rel="stylesheet"  />
    <link href="../Include/css/mainNew.css" rel="stylesheet"  />

    <script src="../Include/JS/bootstrap.min.js" type="text/javascript"></script>
    <script src="../Include/JS/jquery.multiple.select.js" type="text/javascript"></script>
    <style type="text/css">
        .Disabled {
        ...
        #RadSchedulerID.rsNonWorkHour {
            background-color: Red;
        }
    </style>
    <style type="text/css">
        .CurrentTimeSlotStyle {
            background: #CCFFCC !important;
        }

            .CurrentTimeSlotStyle.rsAptCreate {
                background: #CCFFCC !important;
            }
    </style>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ADLeft">
                                <div class="AD-leftPart">
                                    ...
                                    <div class="AdLeft-Calender">
                                        <asp:Calendar ID="dtpDate" runat="server" CellPadding="2" BorderColor="#999999" Font-Names="Verdana"
                                            Font-Size="8pt" Height="180px" ForeColor="Black" DayNameFormat="Short" Width="99%"
                                            BackColor="White" OnSelectionChanged="OnSelectedDateChanged_dtpDate">
                                    ...
                                    <div class="AdLeft-box">
                                        <div class="AdLeft-Facility">
                                            <h3>Facility</h3>
                                            <telerik:RadComboBox ID="ddlFacility" AppendDataBoundItems="true" Width="100%" runat="server"
                                        ...
                                        <div class="AdLeft-Facility">
                                            ...
                                            <telerik:RadComboBox ID="ddlSpecilization" runat="server" AppendDataBoundItems="true"
                                                Filter="Contains" AutoPostBack="true" DropDownWidth="300px" OnSelectedIndexChanged="ddlSpecilization_SelectedIndexChanged" />
                                            <asp:Label ID="lblSpecilization" runat="server" SkinID="label" Text="" Visible="false"></asp:Label>
                                        </div>
                                        <div class="AdLeft-Facility">
                                            <h3>Doctor List</h3>
                                            <telerik:RadComboBox ID="RadLstDoctor" runat="server" AllowCustomText="True" HighlightTemplatedItems="true"
                                                CheckBoxes="true" EnableCheckAllItemsCheckBox="true" DropDownWidth="300px" Height="300px"
                                                Filter="Contains" AutoPostBack="true" OnSelectedIndexChanged="RadLstDoctor_SelectedIndexChanged"
                                                OnItemDataBound="RadLstDoctor_ItemDataBound" />
                                            <asp:CheckBox ID="chkShowAllProviders" runat="server" AutoPostBack="true" Font-Bold="True"
                                                OnCheckedChanged="chkShowAllProviders_CheckedChanged" Text="Show All Provider" />
                                            <asp:HiddenField ID="hdnNoOfEncounter" runat="server" />
                                        </div>
                                        <div class="AdLeft-Btn">
                                            <span class="flatLeft01"><a>
                                                <img src="../Images/searchNew1.png" width="15px" height="15px" /></a>
                                                <asp:Button ID="btnRefresh" runat="server" CssClass="SearchBtn" Text="Search" OnClick="btnRefresh_OnClick" /></span>
                                            <span class="flatLeft01"><a>
                                                <img src="../Images/refreshNew.png" width="15px" height="15px" /></a>
                                                <asp:Button ID="btnClear" runat="server" CssClass="SearchBtn" Text="Clear All" OnClick="btnClear_OnClick" /></span>
                                            <asp:CheckBox ID="chkOptionView" runat="server" AutoPostBack="true" Text="Work Days"
                                                Font-Bold="true" OnCheckedChanged="chkOptionView_CheckedChanged" Visible="false" />
                                        </div>
                                    </div>
                                    <div class="AD-leftPart">
                                        <asp:LinkButton ID="LinkButton3" runat="server" CssClass="AppSearchBtn" Text="List Appointment Details"
                                            Font-Bold="true" OnClick="lnkSearchAppointment_OnClick" OnClientClick="ClientSideClick(this)"
                                            UseSubmitBehavior="False" />
                                        <asp:LinkButton ID="LinkButton4" runat="server" Text="Online Appointment Details"
                                            CssClass="AppSearchBtn" Font-Bold="true" OnClick="lnkOnlineAppointment_OnClick"
                                ...
                                <div class="Appoint-Day">
                                    ...
                                    <div class="Appoint-table">
                                        <div class="demo-container no-bg">
                                            ...
                                            <asp:Label ID="lablecraete" Visible="false" runat="server" Text="No provider(s) found! "
                                                Font-Bold="True" Font-Size="14px"></asp:Label>
                                            <asp:LinkButton ID="btnlink" Visible="false" runat="server" Text="Create a provider!"
                                                Font-Bold="True" Font-Size="11px" PostBackUrl="MPages/Employee.aspx?MPG=P47"></asp:LinkButton>
                                            <telerik:RadScheduler ID="RadScheduler1" runat="server" Skin="Metro" AllowInsert="false"
                                                ...
                                                OnClientAppointmentContextMenu="OnClientAppointmentContextMenu" ShowAllDayRow="false"
                            ...
                            <div class="col-md-1 ADLeft">
                                <div class="App-Summary">
                                    <asp:Button ID="btnFindHours" runat="server" CssClass="NextPageBtn" Text="Find Next"
                                        OnClick="btnFindNext_Click" OnClientClick="ClientSideClick(this)" UseSubmitBehavior="False" />
                                    <asp:Button ID="btnViewProviderTimings" CssClass="NextPageBtn" runat="server" Text="Work Hours"
                                        OnClick="btnViewProviderTimings_Click" OnClientClick="ClientSideClick(this)"
                                        UseSubmitBehavior="False" />
                                </div>
                                <div class="App-Summary">
                                    ...
                                    <div class="AS-chartY" onclick="OnClientNewAppointment(this)">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/SNew-Patient.png" width="36" height="36" alt="New Patient" title="New Patient"
                                                    border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div class="AS-chartG" onclick="OnClientAppointment(this)">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/SAppointments.png" width="36" height="36" alt="Appointments"
                                                    title="Appointment" border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div class="AS-chartP" onclick="OnClientConfirmdAppointment(this)">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/SConfirmed.png" width="36" height="36" alt="Confirmed" title="Confirmed"
                                                    border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div class="AS-chartGreen" onclick="OnClientCheckedInAppointment(this)">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/checkedNew.png" width="36" height="36" alt="Others" title="Checked In"
                                                    border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div class="AS-chartPink" onclick="OnClientCancelleddAppointment(this)">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/SCancelled.png" width="36" height="36" alt="Cancelled" title="Cancelled"
                                                    border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div class="AS-chartPayment" onclick="OnClientPaymentAppointment();">
                                        ...
                                        <div class="AS-chart-right">
                                            <h6>
                                                <img src="../Images/checked.png" width="36" height="36" alt="Others" title="Checked In"
                                                    border="0"></h6>
                                        </div>
                                        <h4>
                                    ...
                                    <div>
                                        <asp:Table ID="tblSummary" runat="server" CellPadding="5" Style="padding-left: 10px;"
                                            Visible="false">
                                        </asp:Table>
                                    </div>
                                </div>
                ...
                <asp:UpdatePanel ID="updDelete" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="lblDeleteMessage" runat="server" Text="Delete ?"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="lblRecurringDeleteMessage" runat="server" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Reason : "></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlRemarks" runat="server" AppendDataBoundItems="true" SkinID="DropDown">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRecurRemark" runat="server" SkinID="textbox" TextMode="MultiLine"
                                        Style="max-height: 70px; min-height: 70px; max-width: 200px; min-width: 200px;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btnDeleteAllApp" SkinID="Button" runat="server" Text="Cancel All"
                                        OnClick="btnDeleteAllApp_Click" />
                                </td>
                                <td>
                                    <asp:Button ID="btnDeleteThisApp" SkinID="Button" runat="server" Text="Cancel This"
                                        OnClick="btnDeleteThisApp_Click" />
                                </td>
                                <td>
                                    <asp:Button ID="btnCancelRecurrApp" SkinID="Button" runat="server" Text="Close" OnClick="btnCancelRecurrApp_OnClick" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
            ...
            <div id="dvDelete" runat="server" visible="false" style="width: 400px; z-index: 100; border: 4px solid #2fb2d4; background-color: White; position: absolute; bottom: 0; height: 170px; left: 40%; top: 300px">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                    <ContentTemplate>
                        <div class="container-fluid header_main">
                            <div class="col-md-12 text-center">
                                <asp:Label ID="lblDeleteApp" runat="server" Font-Bold="true" Text="Delete Appointment ?"></asp:Label></div>
                        </div>

                        <div class="container-fluid">
                            <div class="row form-group">
                                <div class="col-md-12 text-center">
                                    <asp:Label ID="lblDeleteEncounterMessage" runat="server" ForeColor="Red"></asp:Label></div>
                            </div>

                            <div class="row form-groupTop01">
                                <div class="col-md-3 label2">
                                    <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Reason : "></asp:Label><font color='Red'>*</font></div>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlRemarkss" runat="server" AppendDataBoundItems="true" Width="100%"></asp:DropDownList></div>
                            </div>

                            <div class="row form-groupTop01">
                                <div class="col-md-3">
                                    <asp:Label ID="Label6" runat="server" Text="Remarks :"></asp:Label></div>
                                <div class="col-md-9">
                                    <asp:TextBox ID="txtCancel" runat="server" TextMode="MultiLine" Style="height: 70px; width: 100%;"></asp:TextBox></div>
                            </div>
                            ...
                            <div class="row margin_Top">
                                ...
                                <div class="col-md-9">
                                    <asp:Button ID="btnDeleteApp" CssClass="btn btn-primary" runat="server" Text="Cancel" OnClick="btnDeleteApp_Click" />
                                    <asp:Button ID="btnCancelApp" CssClass="btn btn-default" runat="server" Text="Close" OnClick="btnCancelApp_Click" />
                                </div>
                            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="Label2" runat="server" Text="Are You Sure You want to delete all future Break or Only this Break ?" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btnDeleteAllBreak" SkinID="Button" runat="server" Text="Cancel All"
                                        OnClick="btnDeleteAllBreak_Click" Visible="false" />
                                </td>
                                <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="No slot define! Do you still want to give appointment "></asp:Label>
                                </td>
                            </tr>
                            <tr class="cancelDiv01">
                                <td class="ApptBtn">
                                    <asp:Button ID="btnCancel" CssClass="AppointmentNewBtn01" runat="server" Text="Cancel"
                                        OnClick="btnCancel_Click" />
                                    <asp:Button ID="btnMakeAppointment" CssClass="AppointmentNewBtn01" runat="server"
                                        Text="Appointment" OnClick="btnMakeAppointment_Click" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
