...
/// <summary>
/// Summary description for APIRootClass
/// </summary>
public class APIRootClass
{
    public APIRootClass()
    {
        //
    ...
    public class SaveEmiratesIdDetails
    {
    ...
    public class SaveSingleScreenDashboard
    {
        public int HospitalLocationId { get; set; }
        public int RegistrationId { get; set; }
    ...
    public class SaveSinglecarePlanScreenDashboard
    {
    ...
    public class CalculateVitalsValue
    {
        public int HospitalLocationId { get; set; }
    ...
    public class GetTemplateFieldValue
    {
        public int HospitalLocationId { get; set; }
        public int SectionId { get; set; }
        public int FieldId { get; set; }
    ...
    public class GetInvestigationsResult
    {
        public int HospitalLocationId { get; set; }
        public int FacilityId { get; set; }
        public int EncounterId { get; set; }
    ...
    public class GetVolumeUnitMaster
    {
        public int HospitalLocationId { get; set; }
        public int FacilityId { get; set; }
        public int IsVolumeUnit { get; set; }
    }
    ...
    {
        public string strPrescriptionDetail { get; set; }
        public int HospitalLocationId { get; set; }
        public int FacilityId { get; set; }
        public int RegistrationId { get; set; }
        public int EncounterId { get; set; }
    ...
    public class GetEMRDataForSingleScreen
    {
        ...
        public int pageSize { get; set; }
        public int PageNo { get; set; }
        public bool IsCopyLastOPDSummary { get; set; }
    }
    ...
    public class getAdmissionDetailsFromRegistrationNo
    {
        public int RegistrationNo { get; set; }
    }
    ...
    {
        public int intLoginFacilityId { get; set; }
        public string chrSource { get; set; }
        public int intLabNo { get; set; }
        public int intStationId { get; set; }
        public int chvServiceIds { get; set; }
        public string RegNo { get; set; }
        public int IPNo { get; set; }
        public string LabNo { get; set; }
        public int chvDiagSampleIds { get; set; }
        public string facilityName { get; set; }
    }

    public class GetPrescriptionReport
    {
        public string UserName { get; set; }
