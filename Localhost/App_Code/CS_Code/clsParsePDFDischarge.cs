...
/// </summary>
public class PDFPageEventHandlerSummary : PdfPageEventHelper
{
    ...
    string _LowestFooter1;
    string _LowestFooterImage;
    ...
    public string LowestFooter1
    {
        get { return _LowestFooter1; }
        set { _LowestFooter1 = value; }
    }
    public string LowestFooterImage
    {
        get { return _LowestFooterImage; }
        set { _LowestFooterImage = value; }
    }
    #endregion
    ...
    public override void OnEndPage(PdfWriter writer, Document document)
    {
        ...
        //palendra change
        if (LowestFooterImage != null)
        {
            //-------------
            //new1 
            Image image = iTextSharp.text.Image.GetInstance(LowestFooterImage);
            ...
            Rectangle page1 = document.PageSize;
            content.TotalWidth = page1.Width;
            content.DefaultCell.PaddingLeft = 70f;
            content.DefaultCell.PaddingRight = 60f;
            content.DefaultCell.Border = Rectangle.NO_BORDER;
            content.AddCell(image);
            content.WriteSelectedRows(0, -1, 0, content.TotalHeight + 14, writer.DirectContent);
            //-------------
        }
        ...
        // row 2
        var boldFont1 = FontFactory.GetFont(FontFactory.HELVETICA, 9);
        if (common.myStr(System.Web.HttpContext.Current.Session["FacilityName"]).ToUpper().Contains("QRG MEDICARE LTD") || common.myStr(System.Web.HttpContext.Current.Session["FacilityName"]).ToUpper().Contains("QRG CENTRAL HOSPITAL & RESEARCH CENTRE LTD"))
        {
        }
        else
        {
            Phrase phraseleft1 = new Phrase(LowestFooter, boldFont1);
            ...
            var boldFont2 = FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 9);
            Phrase phraseleft2 = new Phrase(LowestFooter1, boldFont2);
            PdfPCell cL2 = new PdfPCell(phraseleft2);
            cL2.Colspan = 3;
            //cL2.Border = Rectangle.TOP_BORDER;
            cL2.PaddingLeft = 10;
            cL2.Border = Rectangle.NO_BORDER;
            cL2.VerticalAlignment = Element.ALIGN_BOTTOM;
            cL2.HorizontalAlignment = Element.ALIGN_LEFT;

            if (LowestFooter1 != string.Empty)
            {
                footer.AddCell(cL2);
            }
...
/// <summary>
/// Summary description for PDFPageEventHandlerSummary
/// </summary>
public class clsParsePDFDischarge
{
    public clsParsePDFDischarge()
    {
        //
    ...
    private string _footerfinalizedby; //Added by Shabana on 21/05/2022
    private string _footercentertext;
    private string _lowestfooter;

    private string _lowestfooter1;
    private string _lowestfooterImage;
    ...
    //Added by Shabana on 21/05/2022
    public string FooterFinalizedBy
    {
        get { return _footerfinalizedby; }
        set { _footerfinalizedby = value; }
    }
    public string FooterCenterText
    {
        get { return _footercentertext; }
    ...
    public System.IO.MemoryStream ParsePDF(bool IsHidePaging)
    {
        ...
        PDFPageEventHandlerSummary PageEventHandler = new PDFPageEventHandlerSummary();
        ...
        PageEventHandler.LowestFooterImage = LowestFooterImage;
        PageEventHandler.LowestFooter1 = LowestFooter1;
        ...
        for (int k = 0; k < objects.Count; k++)
        {
            ...
            {
                if (((iTextSharp.text.List)(objects[k])).Items.Count > 0)
                {
                ...
                {
                    foreach (iTextSharp.text.List lst in ((iTextSharp.text.List)(objects[k])).Items)
                    {
                        lst.IndentationLeft = 12;
                    }
                }
    ...
    {
        string[] strAllFont;
        // string strFontpathALL = "D:/Kuldeep Kumar/Akhil Projects/Cloud DevOps/CommonEmr/Localhost/Fonts"; // Environment.GetFolderPath(specialFolder);
