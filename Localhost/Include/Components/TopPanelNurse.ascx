<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TopPanelNurse.ascx.cs" Inherits="Include_Components_TopPanelNurse" %>
                                ...
                                <tr align="center">
                                   ...
                                   <asp:Label ID="lblAge" runat="server" /><asp:Label ID="lblGender" runat="server" />
                                    ...
                                    <td data-priority="6" colspan="1" data-columns="tech-companies-1-col-6">
                                        ...
                                        <%--Visit--%> Date: &nbsp;<asp:Label ID="lblEncDate" runat="server" />
