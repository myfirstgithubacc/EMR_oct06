...
! function (a) {
    ...
    if (a.FE.LinkRegExCommon = "[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function (b) {
         ...
         try {
          ...
          if (i.nextSibling == k || k.nextSibling == i) {
           ...
           if (u && u.nodeType == Node.TEXT_NODE)
            for (; u && u.nextSibling && u.nextSibling.nodeType == Node.TEXT_NODE;) u.nextSibling.textContent = u.textContent + u.nextSibling.textContent, u = u.nextSibling,
      ...
      function E(a, c) {
       ...
       if (b.core.isEmpty()) b.opts.fullPage && (d = r(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.find("head").get(0).outerHTML + "<body></body></html>");
    else if ("undefined" == typeof a && (a = !1), b.opts.fullPage) {
        d = r(b.iframe_document), b.$el.removeClass("fr-view");
        var y = b.opts.heightMin;
        b.opts.heightMin = null, b.size.refresh(), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>", b.opts.heightMin = y, b.size.refresh(), b.$el.addClass("fr-view")
    } else d = b.$el.html();
       if (!b.opts.useClasses && !c)
       ...
       var z = b.events.chainTrigger("html.get", d);
       return "string" == typeof z && (d = z), d = d.replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function (a) {
      ...
      function m(d) {
       ...
       if (!b.node.isBlock(e) && b.node.isEditable(e)) {
        ...
        i && "BR" == i[0].tagName && a(i[0]).remove(), i && "BLOCKQUOTE" == e.tagName) {
        var j = i[0];
    ...
    while (i != h);
      ...
      function c(a) {
       b.opts.multiLine ? b.helpers.isIOS() ? J = b.snapshot.get() : (a.preventDefault(), a.stopPropagation(), b.selection.isCollapsed() || b.selection.remove(), b.cursor.enter()) : (a.preventDefault(), a.stopPropagation())
    }
      ...
      function i() {
       if (b.browser.mozilla && b.selection.isCollapsed() && !I) {
      ...
      function p(i) {
       b.events.disableBlur(), J = null;
       var j = i.which;
       if (16 === j) return !0;
       if (F = j, j === a.FE.KEYCODE.IME) return I = !0, !0;
       I = !1;
      ...
      function t(c) {
       if (c && 0 === c.which && F && (c.which = F), b.helpers.isIOS() && c && J && c.which == a.FE.KEYCODE.ENTER && (b.snapshot.restore(J), b.cursor.enter()), b.helpers.isAndroid() && b.browser.mozilla) return !0;
       if (I) return !1;
      ...
      function x(c) {
       var d = c.which;
       return u(c) || d >= 37 && 40 >= d || !w(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.IME ? !0 : (G || (H = b.snapshot.get(), b.undo.canDo() || b.undo.saveStep()), clearTimeout(G), void (G = setTimeout(function () {
        G = null, b.undo.saveStep()
    }, Math.max(250, b.opts.typingTimer))))
    }

      function y(a) {
       var c = a.which;
       return u(a) || c >= 37 && 40 >= c ? !0 : void (H && G ? (b.undo.saveStep(H), H = null) : "undefined" != typeof c && 0 !== c || H || G || b.undo.saveStep())
    }

      function z() {
       G && (clearTimeout(G), b.undo.saveStep(), H = null)
    }
      ...
      function B(a) {
       return a && "BR" == a.tagName ? !1 : 0 === (a.textContent || "").length && a.querySelector && !a.querySelector(":scope > br")
    }

      function C(c) {
       var d = b.el.childNodes,
        e = b.html.defaultTag();
       return c.target && c.target !== b.el ? !0 : 0 === d.length ? !0 : void (b.$el.outerHeight() - c.offsetY <= 10 ? B(d[d.length - 1]) && (e ? b.$el.append("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.append(a.FE.MARKERS + "<br>"), b.selection.restore(), r()) : c.offsetY <= 10 && B(d[0]) && (e ? b.$el.prepend("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.prepend(a.FE.MARKERS + "<br>"), b.selection.restore(), r()))
    }
      ...
      function E() {
       if (b.events.on("keydown", x), b.events.on("input", i), b.events.on("mousedown", m), b.events.on("keyup input", y), b.events.on("keypress", l), b.events.on("keydown", p), b.events.on("keyup", t), b.events.on("destroy", D), b.events.on("html.inserted", t), b.events.on("cut", j), b.events.on("click", C), !b.browser.edge && b.el.msGetInputContext) try {
      ...
      function e(c) {
       ...
       c.addClass("fr-blink").toggleClass("fr-active"), c.hasClass("fr-active") ? (e.attr("aria-hidden", !1), c.attr("aria-expanded", !0)) : (e.attr("aria-hidden", !0), c.attr("aria-expanded", !1)), setTimeout(function () {
        ...
        g.parent(".fr-toolbar:not(.fr-inline)").css("zIndex", ""), 0 !== c.parents(".fr-popup").length || b.opts.toolbarInline || (b.node.hasClass(c.get(0), "fr-active") ? b.$tb.css("zIndex", (b.opts.zIndex || 1) + 4) : b.$tb.css("zIndex", ""));
      ...
      function d() {
       var d = a.merge([], e());
       c(d, v[a.FE.XS]), c(d, v[a.FE.SM]), c(d, v[a.FE.MD]), c(d, v[a.FE.LG]);
      ...
      return {
       ...
       this.fontFamily.refreshOnShow(a, b)
        ...
        fontSize: ["8", "9", "10", "11", "12", "14","16", "18", "24", "30", "36", "48"],
        fontSizeSelection: !1,
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        defaultSelection: function (a) {
            return a.opts.paragraphFormat.N
        },
        ...
        function c(c, d, e) {
            ...
            b.selection.save();
            for (var h = a(g[0]).hasClass(c), i = 0; i < g.length; i++) a(g[i]).removeClass('fr-text-lowercase').addClass(c);//.toggleClass(c, !h), a(g[i]).hasClass("fr-temp-div") && a(g[i]).removeClass("fr-temp-div"), "" === a(g[i]).attr("class") && a(g[i]).removeAttr("class");
            ...
            b.events.$on(l, "keydown", function (c) {
                ...
                if (d == a.FE.KEYCODE.TAB || d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT) {
                    ...
                    return d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT ? (i = d == a.FE.KEYCODE.ARROW_RIGHT, k = !0) : i = !c.shiftKey, f.length ? (k && (h = i ? f.nextAll("span.fr-special-character:first") : f.prevAll("span.fr-special-character:first")), h && h.length || (h = i ? f.parent().next().find("span.fr-special-character:first") : f.parent().prev().find("span.fr-special-character:" + (k ? "last" : "first")),
                     h.length || (h = l.find("span.fr-special-character:" + (i ? "first" : "last"))))) : h = l.find("span.fr-special-character:" + (i ? "first" : "last")), e(h, c), !1
                }
    ...
    //a.FE.DefineIcon("Uppercase", {
    //    NAME: "uppercase"
    //}), a.FE.RegisterCommand("uppercase", {
    //    title: "Uppercase",
    //    focus: !1,
    //    toggle: !0,
    //    callback: function () {
