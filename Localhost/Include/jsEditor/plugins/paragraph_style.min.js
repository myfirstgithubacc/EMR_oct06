...
! function (a) {
    ...
    a.extend(a.FE.DEFAULTS, {
        ...
        function c(c, d, e) {
            ...
            b.selection.save();
            for (var h = a(g[0]).hasClass(c), i = 0; i < g.length; i++) a(g[i]).removeClass(f).removeClass('fr-text-lowercase').addClass(c);//toggleClass(c, !h), a(g[i]).hasClass("fr-temp-div") && a(g[i]).removeClass("fr-temp-div"), "" === a(g[i]).attr("class") && a(g[i]).removeAttr("class");
