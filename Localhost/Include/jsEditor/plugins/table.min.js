...
! function (a) {
    ...
    a.FE.DefineIcon("bold1", {
        NAME: "bold"
    }), a.FE.RegisterCommand("bold1", {
        title: "Bold",
        toggle: !0,
        callback: function () {
            var a = this.popups.get("table.edit").find('.fr-command[data-cmd="bold1"]');
            a.hasClass("fr-active") ? ($('.fr-selected-cell').css({ 'font-weight': 'normal' }),a.removeClass("fr-active").attr("aria-pressed", !1)) : ($('.fr-selected-cell').css({ 'font-weight': 'bold' }),a.addClass("fr-active").attr("aria-pressed", !0));
           // a.hasClass("fr-active") ? a.removeClass("fr-active").attr("aria-pressed", !1) : a.addClass("fr-active").attr("aria-pressed", !0)
        },
        refresh: function (a) {
           // a.hasClass("fr-active") ? a.removeClass("fr-active").attr("aria-pressed", !1) : a.addClass("fr-active").attr("aria-pressed", !0)
            //var b = a.hasClass("fr-active");
            //a.toggleClass("fr-active", b).attr("aria-pressed", b)
        }
    }),
      a.FE.DefineIcon("italic1", {
          NAME: "italic"
      }), a.FE.RegisterCommand("italic1", {
          title: "italic",
          toggle: !0,
          callback: function () {
              var a = this.popups.get("table.edit").find('.fr-command[data-cmd="italic1"]');
              a.hasClass("fr-active") ? $('.fr-selected-cell').css({ 'font-style': 'normal' }) : $('.fr-selected-cell').css({ 'font-style': 'italic' })
              //a.hasClass("fr-active") ? a.removeClass("fr-active").attr("aria-pressed", !1) : a.addClass("fr-active").attr("aria-pressed", !0)
          },
          refresh: function (a) {
      ...
      a.FE.DefineIcon("underline1", {
          NAME: "underline"
      }), a.FE.RegisterCommand("underline1", {
          title: "underline",
          toggle: !0,
          callback: function () {
              var a = this.popups.get("table.edit").find('.fr-command[data-cmd="underline1"]');
              a.hasClass("fr-active") ? $('.fr-selected-cell').css({ 'font-style': 'normal' }) : $('.fr-selected-cell').css({ 'text-decoration': 'underline' })
              //a.hasClass("fr-active") ? a.removeClass("fr-active").attr("aria-pressed", !1) : a.addClass("fr-active").attr("aria-pressed", !0)
          },
          refresh: function (a) {
              var b = this.format.is("strong");
     ...
     //a.FE.DefineIcon("paragraphStyle1", {
     //    NAME: "magic"
     //}), a.FE.RegisterCommand("paragraphStyle1", {
     //    type: "dropdown",
     //    focus: !1,
