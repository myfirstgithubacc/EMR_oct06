...
public partial class OTScheduler_ReportActualOTBooking : System.Web.UI.Page
{
    ...
    {
        RadWindowForNew.NavigateUrl = "/EMRBILLING/Report/PreView.aspx?FromDate=" + dtpfromdate.SelectedDate + "&Todate=" + dtpTodate.SelectedDate + "&Export=" + chkExport.Checked + "&RptName=OT&RptType=Detail&Status=" +common.myStr(ddlStatus.SelectedValue) + "&IsActual=1";
