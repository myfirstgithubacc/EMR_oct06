<%@ Page Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master" AutoEventWireup="true" CodeFile="ReportActualOTBooking.aspx.cs" Inherits="OTScheduler_ReportActualOTBooking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-fluid header_main form-group">
        <div class="col-md-3"><h2><asp:Label ID="lblHeader" runat="server" Text="Report Actual OT Booking Details" /></h2></div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-offset-3 col-md-5 header_main main_box">
                ...
                <div class="row form-groupTop01">
                    <div class="col-md-12">
                        <div class="col-md-3 label2"><asp:Label ID="Label4" runat="server" Text="OT Status"></asp:Label></div>
                        <div class="col-md-3">
