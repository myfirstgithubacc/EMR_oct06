<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPSaleDocReport.aspx.cs"
    Inherits="Pharmacy_Reports_IPSaleDocReport" Title="IP Sale Issue Document" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PrintFunc(ControlName) {
            setTimeout('ReportFrame' + ControlName + '.print();', 3000);
        }
...
<body>
    ...
    <div>
        ...
        <%--<input type="button" value="Print" onclick="ready();" />--%>
        <%--ShowBackButton="true" ShowExportControls="false" ShowPrintButton="true" ShowToolBar="false" ShowRefreshButton="false"--%>
        <rsweb:ReportViewer ID="ReportViewer1" Height="500px" Width="100%" runat="server"
