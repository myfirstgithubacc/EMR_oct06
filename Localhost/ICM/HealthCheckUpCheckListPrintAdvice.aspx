<%@ Page Title="" Language="C#" MasterPageFile="~/Include/Master/EMRMasterWithTopDetails_1.master" AutoEventWireup="true" CodeFile="HealthCheckUpCheckListPrintAdvice.aspx.cs" Inherits="ICM_HealthCheckUpCheckList" %>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                     <asp:Button ID="btnPrintAdvice" runat="server" Text="Print" CssClass="PatientLabBtn01" OnClick="btnPrintAdvice_OnClick"  />
            ...
            <div class="row">        
                ...
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="EMR-HealthCheckBox02">
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="5%">
                                <ItemTemplate><asp:CheckBox ID="chkTemplate" runat="server" Enabled="true" /></ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Advicer Template" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hdnIsData" runat="server" Value='<%#Eval("IsData")%>' />
                                       ...
                                       <asp:HiddenField ID="hdnDoctorIdMHC" runat="server" Value='<%#Eval("DoctorId")%>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
