...
public partial class ICM_PrintDischargeSummary : System.Web.UI.Page
{
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                switch (common.myStr(Caption).ToUpper().Trim())
                {
                    ...
                    case "WBN":
                        ...
                        break;
                    case "DQUAL": // yogesh 20/08/2022
                        value = common.myStr(ds.Tables[0].Rows[0]["DoctorQualification"]);
                        break;
                    default:
                        value = string.Empty;
                        break;
