<%@ Page Title="" Language="C#" MasterPageFile="~/Include/Master/BlankMaster.master" AutoEventWireup="true" CodeFile="OrderApproval.aspx.cs" Inherits="EMRBILLING_Popup_OrderApproval" %>
            ...
            <div id="Table1" runat="server">
                <div class="container-fluid header_main">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <h2>
                            <asp:Label ID="lblPageType" runat="server" Text="Orders Approval" /></h2>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 text-right pull-right">
                        ...
                        <asp:Button ID="ibtnSave" runat="server" AccessKey="S" CssClass="btn btn-primary" Text="Approved (Ctrl+F3)" ToolTip="Save srvices..." ValidationGroup="save" OnClick="ibtnSave_Click" />
                                ...
                                <ContentTemplate>
                                    ...
                                    <telerik:RadGrid ID="gvOrderApproval" runat="server" RenderMode="Lightweight" Skin="Office2007"
                                        ...
                                        <MasterTableView TableLayout="Auto">
                                            ...
                                            <Columns>
                                                <telerik:GridTemplateColumn UniqueName="UniqueName1"
