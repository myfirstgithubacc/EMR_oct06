<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DischargeSummaryAcknowledgement.aspx.cs" Inherits="WardManagement_DischargeSummaryAcknowledgement" %>
...
<head runat="server">
    <title>Discharge Summary Acknowledgement</title>
...
<body>
    ...
    <asp:ScriptManager ID="Scrptmanger1" runat="server"></asp:ScriptManager>
        ...
        <div class="container-fluid header_main">
            <div class="col-md-2"><h2>Discharge Summary Acknowledgement</h2></div>
            ...
            <div class="row" id="Table2" runat="server">
                <div class="col-md-offset-4 col-md-4">
                    ...
                    <div class="row form-groupTop01" id="trEdod" runat="server">
                        <div class="col-md-5 PaddingRightSpacing label2"><asp:Label ID="Label1" runat="server" Text="Acknowledgement&nbsp;Date :"></asp:Label><span style="color: Red">*</span></div>
                        <div class="col-md-7">

                            <%--<telerik:RadDatePicker ID="dtpEod" Width="100%" runat="server"></telerik:RadDatePicker>--%>
                            <telerik:RadDateTimePicker ID="txtAckDate" Enabled="false" runat="server" DateInput-DateFormat="dd/MM/yyyy HH:mm" /></div>
