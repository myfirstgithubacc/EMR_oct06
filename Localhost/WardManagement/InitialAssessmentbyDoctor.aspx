<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InitialAssessmentbyDoctor.aspx.cs" Inherits="WardManagement_InitialAssessmentbyDoctor" %>
...
<head runat="server">
    <title>Initial Assessment by Doctor</title>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="container-fluid header_main">
                    <div class="col-md-2">
                        <h2>Initial Assessment by Doctor</h2>
                    </div>
