<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingBillingStatus.aspx.cs"
    Inherits="EMRBILLING_Popup_PendingBillingStatus" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table id="Table1" runat="server" border="0" class="clsheader" width="100%" cellpadding="0"
                cellspacing="0">
                <tr>
                    <td width="150px">&nbsp;&nbsp;<asp:Label ID="lblDate" runat="server" SkinID="label" Text="Date" />
                        <telerik:RadComboBox ID="ddlrange" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlrange_SelectedIndexChanged"
                            ...
                            <Items>
                                <telerik:RadComboBoxItem Value="DD0" Text="Today" />
                    ...
                    <td width="400px">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="btnEdod" runat="server" Text=""></asp:Label>
