...
public partial class WardManagement_InitialAssessmentbyDoctor : System.Web.UI.Page
{
    ...
    void BindDischargeOutlierRemarks()
    {
        ...
        DataSet dsStatus = objw.GetPatientDischargeSummaryAcknowledgementStatus(common.myInt(Session["EncounterId"]), "InitialAssessmentbyDoctor");
        if (dsStatus.Tables[0].Rows.Count > 0)
        {
            ...
            txtAckDate.SelectedDate = (common.myDate(dsStatus.Tables[0].Rows[0]["InitialAssessmentDoctorDate"]));
