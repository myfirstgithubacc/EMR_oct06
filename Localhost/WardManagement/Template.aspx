<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Template.aspx.cs" Inherits="WardManagement_Template" %>
        ...
        <asp:UpdatePanel ID="upd1" runat="server">
            <ContentTemplate>
                <div class="container-fluid header_main form-group">
                    <div class="col-sm-8 text-center"><asp:Label ID="lblMessage" runat="server" Text="&nbsp;" /></div>
