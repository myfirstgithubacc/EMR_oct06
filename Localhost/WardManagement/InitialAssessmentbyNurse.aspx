<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InitialAssessmentbyNurse.aspx.cs" Inherits="WardManagement_InitialAssessmentbyNurse" %>
...
<head runat="server">
    <title>Initial Assessment by Nurse</title>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="container-fluid header_main">
                    <div class="col-md-2">
                        <h2>Initial Assessment by Nurse</h2>
                    </div>
     ...
     <%--   <table cellspacing="0" class="table table-small-font table-bordered table-striped">
            <tbody>
                ...
                <div id="Table1" runat="server">
                    ...
                    <div class="row m-auto" id="Table2" runat="server">
                        <div class="col-md-4 col-8 m-auto" style="background:#c1e5ef; padding:6px 22px;">

                            <div class="row form-groupTop01 backgroundColor" id="trEdod" runat="server">
                                <div class="col-5 PaddingRightSpacing label2">
                                    <asp:Label ID="Label1" runat="server" Text="Acknowledgement&nbsp;Date :"></asp:Label><span style="color: Red">*</span></div>
                                <div class="col-7">

                                    <%--<telerik:RadDatePicker ID="dtpEod" Width="100%" runat="server"></telerik:RadDatePicker>--%>
                                    <telerik:RadDateTimePicker ID="txtAckDate" Enabled="false" runat="server" DateInput-DateFormat="dd/MM/yyyy HH:mm" />
                                </div>

                            </div>
                            <div class="row margin_Top backgroundColor">
