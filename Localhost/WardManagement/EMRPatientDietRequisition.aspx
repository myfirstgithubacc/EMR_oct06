    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr class="clsheader" bgcolor="#e3dcco">
            <td style="width: 100px">
               ...
               <%-- <telerik:RadDatePicker ID="dietDate" runat="server" DateInput-ShowButton="true"></telerik:RadDatePicker>--%>
            </td>
            <td align="center">
            ...
            <td style="width: 300px">
                <%--<asp:UpdatePanel ID="upnmenustrip" runat="server">
                    <ContentTemplate>--%>
                <asp:Button ID="btnNew" SkinID="Button" runat="server" Text="New" OnClick="btnNew_Click" />
                <asp:Button ID="btnSave" runat="server" BackColor="#FFCBA4" Text="Save (Ctrl+F3)" Font-Bold="true"
                    OnClick="btnSave_Click" />
                <asp:Button ID="btnPrev" SkinID="Button" runat="server" Visible="false" Text="Prev. Diet" />
                <asp:Button ID="btnClose" SkinID="Button" runat="server" Text="Close" OnClientClick="window.close();" />
                        ...
                        <td>
                            <asp:UpdatePanel ID="update1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <telerik:RadComboBox ID="ddlDietTypeCategory" SkinID="DropDown" runat="server" Width="120px"
                                    ...
                                    <telerik:RadComboBox ID="ddlNPO" SkinID="DropDown" runat="server" OnSelectedIndexChanged="ddlNPO_OnSelectedIndexChanged"
                                    ...
                                    <telerik:RadComboBox ID="ddlModeofFeeding" SkinID="DropDown" runat="server"
                                        Height="350px" Filter="Contains" MarkFirstMatch="true" />
                        ...
                        <td valign="top">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="txtRemakrs" runat="server" MaxLength="200" Width="260px"
                                        SkinID="textbox" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbldiagnosis" runat="server" SkinID="label" Text="Diagnosis" />
                                    <span style="color: Red">*</span>
                                    <asp:TextBox ID="txtdiagnosis" runat="server" MaxLength="200"  Width="150px"
				    SkinID="textbox" 
                                        TextMode="MultiLine" Style="min-height: 50px; max-height: 50px; min-width: 160px; max-width: 160px; line-height: 1.0em;" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
