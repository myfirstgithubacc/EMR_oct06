<%@ Page Language="C#" MasterPageFile="~/Include/Master/EMRMaster.master" AutoEventWireup="true" CodeFile="OutSource.aspx.cs" Inherits="LIS_Phlebotomy_OutSource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style>
        ...
        label#ctl00_ContentPlaceHolder1_lblServiceName {
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" runat="server" Width="650" Height="580"
            ...
            VisibleOnPageLoad="false" ReloadOnShow="true" Skin="Office2007">
        ...
        <asp:UpdatePanel ID="valMain" runat="server">
            <ContentTemplate>
                <telerik:RadWindowManager ID="RadWindowManager" EnableViewState="false" runat="server"
                    Behaviors="Close" ReloadOnShow="true" Skin="Office2007">
                    <Windows>
                ...
                <div style="overflow-y: hidden; overflow-x: hidden;">
                    ...
                    <div class="container-fluid header_main " style="padding:6px 6px;">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12 text-right">
                                <asp:Button ID="btnsave" runat="server" OnClick="btnsave_Click" Visible="false" Text="Save" CssClass="btn btn-primary"
                                    OnClientClick="ClientSideClick(this)" UseSubmitBehavior="false" />

                                <asp:Button ID="btnViewResult" CssClass="btn btn-primary" runat="server" Text="View Result" ToolTip="View Result" OnClick="btnViewResult_Click" />
                    ...
                    <div class="container-fluid">
                        <div class="row" style="margin-bottom: 8px!important; margin-top: 8px!important;">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4 col-4">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-5 mt-md-1 m-0">
                                                <label class="Resultdate mb-0">Result Date</label>
                                            </div>
                                            <div class="col-ld-8 col-md-7">
                                    ...
                                    <div class="col-md-6 col-8">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 mt-md-1 m-0">
                                                <label id="lblServiceName" class="mb-0" runat="server">Service Name</label>
                                            </div>
                                            <div class="col-lg-7 col-md-6 col-8">
                                                <telerik:RadComboBox ID="ddlService" runat="server" Width="100%" DropDownWidth="350px" Height="300px" Skin="Office2010Black" EmptyMessage="Select Service Name" Filter="Contains" />
                                            </div>
                            ...
                            <asp:UpdatePanel ID="upd1" runat="server">
                                <ContentTemplate>
                                    <div style="display: none;">
                                        ...
                                        <telerik:RadWindowManager ID="RadWindowManager3" EnableViewState="false" runat="server" Skin="Office2007" Behaviors="Close,Move,Pin,Resize,Maximize" ShowContentDuringLoad="false" VisibleStatusbar="false" ReloadOnShow="true">
                                            <Windows>
                                                <telerik:RadWindow ID="RadWindowForNew" Skin="Office2007" runat="server" />
                                            </Windows>
                                        </telerik:RadWindowManager>
